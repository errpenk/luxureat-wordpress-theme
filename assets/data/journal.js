(() => {
  ...
  const images = {
    ...
    aboutRoberto: articleImage("about-roberto.png"),
    aboutDining: articleImage("about-trufflebar-dining.png"),
    aboutBar: articleImage("about-trufflebar-bar.png"),
    aboutProducts: articleImage("about-truffle-products.png"),
    aboutMap: articleImage("about-global-map.png"),
    aboutCaviar: articleImage("about-caviar.png"),
    aboutShrimp: articleImage("about-shrimp-tartare.png"),
    aboutBurger: articleImage("about-mediterranean-burger.png"),
    caviarWorld: articleImage("caviar-world-map.png"),
    italianCaviar: articleImage("italian-caviar-market.png"),
    caviarEtiquette: articleImage("caviar-etiquette-service.png"),
    philosophy: articleImage("luxureat-philosophy.png"),
    recipeTruffleEggs: articleImage("recipe-truffle-eggs.png"),
    recipeTruffleToast: articleImage("recipe-truffle-toast.png"),
    recipeTruffleTagliolini: articleImage("recipe-truffle-tagliolini.png"),
    recipeTruffleRavioli: articleImage("recipe-truffle-ravioli.png"),
    recipeBlackTruffleRisotto: articleImage("recipe-black-truffle-risotto.png"),
    recipeMushroomSoup: articleImage("recipe-mushroom-soup.png"),
    recipeBeefCarpaccioScallopTruffle: articleImage("recipe-beef-carpaccio-scallop-truffle.png"),
    recipeShrimpTartareTruffle: articleImage("recipe-shrimp-tartare-truffle.png"),
    recipeSweetBreadButterCaviar: articleImage("recipe-sweet-bread-butter-caviar.png"),
    recipeTruffleTiramisu: articleImage("recipe-truffle-tiramisu.png"),
  };
  const articles = {
    "zh-about": {
      lang: "zh", eyebrow: "关于我们", title: "LuxurEat｜从意大利家族餐桌，到世界高端美食版图", meta: "MAISON · 品牌故事",
      image: images.aboutRoberto,
      intro: "LuxurEat的故事，始于意大利家庭餐桌上代代相传的味道。",
      opening: [
      ...
      sections: [
        ["从松露开始的美食事业", [
          ...
          "LuxurEat从TrufflEat积累的行业经验中发展而来，业务范围也从松露逐步扩展至鱼子酱、高端调味品和其他精品食品。品牌希望在保留意大利传统风味与手工品质的同时，通过产品创新，让高端食材进入更多餐饮和日常消费场景。",
          "2018年，团队在曼谷开设了TruffleBar & Restaurant，将意大利松露文化带入亚洲餐饮市场。虽然餐厅在2020年因疫情限制关闭，但这一项目成为品牌国际化发展过程中的重要阶段，也推动团队进一步转向全球销售、合作经营与品牌拓展。",
        ]],
        ["从意大利走向世界", [
          "如今，LuxurEat已经发展为一家专注于松露、鱼子酱和高端食品的国际集团，在意大利、美国、泰国和中国设有公司或业务机构，并通过合作伙伴和经销渠道进入欧洲、亚洲、中东和美国等市场。",
          "集团旗下业务涵盖TrufflEat、CaviarEat、LuxurEat及Ugolini Gourmet等品牌和产品线，面向餐厅、零售商、经销商及国际食品企业提供产品销售和商业合作服务。",
          "除了经营自有品牌，LuxurEat还提供自有品牌和OEM定制服务，包括产品配方开发、包装设计、意大利生产以及国际出口，帮助合作伙伴将产品从概念转化为适合不同市场的商业方案。",
        ]],
        ["传统、创新与全球视野", [
          "对LuxurEat而言，意大利制造不仅意味着产品的原产地，也代表对食材、工艺和饮食文化的尊重。",
          "品牌以意大利美食传统为基础，同时关注健康、可持续发展和不同国际市场的食品需求，开发植物基、无麸质、低致敏以及符合Halal和Kosher要求的产品方案。",
          "从一个意大利家庭的餐桌记忆，到覆盖多个国家和地区的高端食品业务，LuxurEat始终围绕同一个目标发展：将意大利的真实风味、优质食材与创新产品带向世界，让传统美食在新的市场和消费场景中持续焕发活力。",
        ]],
      ],
      sectionMedia: [
        [
        ...
        [
          { src: images.aboutProducts, alt: "LuxurEat 松露产品系列" },
          { src: images.aboutMap, alt: "LuxurEat 全球业务布局" },
        ],
        [
          { src: images.aboutCaviar, alt: "LuxurEat 白鲟鱼子酱" },
          { src: images.aboutShrimp, alt: "LuxurEat 鲜虾塔塔产品" },
          { src: images.aboutBurger, alt: "LuxurEat 地中海鱼肉饼" },
        ],
      ],
    ...
    "zh-harvest": {
      ...
      intro: "LuxurEat是一家专注于美食领域的国际集团，主要经营松露、鱼子酱和高端食品。",
      opening: ["集团源于TrufflEat积累的经验，并逐步发展成为一家面向全球市场的企业，积极开展美食产品的生产、分销与开发。家庭背景、对美食的热情以及创业愿景，共同孕育了LuxurEat。"],
      sections: [
        ["我们的理念", ["LuxurEat的理念根植于对意大利美食传统的深切尊重，并建立在三个核心原则之上：负责任的创新、切实的可持续性和负责任的采购。", { type: "quote", bold: [0, 2, 4], lines: ["传统", "我们深深植根于意大利美食文化，重视代代相传的传统、经验与工艺。每一件产品都由意大利工匠精心打造，体现对品质、原料与制作工艺的重视。", "创新", "我们持续开发以健康为导向的创新产品，包括排毒、清淡、无麸质和无过敏原产品，以回应不同消费者对健康饮食的需求。", "可持续性", "我们通过合乎道德且具有包容性的产品和服务，倡导对环境、生物多样性和食物多样性的尊重。我们尊重生物多样性，倡导可持续农业，并支持符合道德规范的营养选择，包括清真、犹太洁食和纯素食产品。"] }]],
        ["我们的哲学", ["对LuxurEat而言，真正的美食不仅来自珍贵的食材，更来自对传统、品质、健康与环境的共同坚持。我们的哲学贯穿从原料甄选、产品制作到包装呈现的每一个环节。", { type: "quote", bold: [0, 2, 4, 6], lines: ["历史", "我们致敬由意大利大师代代相传的食谱与制作工艺。传统并不只是对过去的复制，而是通过时间沉淀下来的经验与判断，让食材保留最初的纯真、层次与深度。", "甄选", "品质始于原料。我们坚持严苛的甄选标准，重视食材的产地、季节与自然状态。只有达到高品质要求的季节性食材，才能进入LuxurEat的产品典藏。", "健康", "我们相信，保存时间不应以牺牲营养与天然风味为代价。因此，我们重视天然的保存方式，在延长产品品质的同时，尽可能保留食材原有的营养、口感与特性。", "永续", "每一种食材都来自土地与自然。我们通过符合伦理的采购方式和更加环保的包装选择，减少对环境的负担，并以实际行动表达对土地、生态与未来的尊重。"] }, "这些价值观体现在公司的每一个选择中，从甄选优质原料、支持可持续农业，到坚持符合道德与包容性要求的严格国际食品标准。", "秉持诚信、真实与卓越的精神，LuxurEat致力于为全球消费者提供一种既传承意大利传统，又具有前瞻性视野的美食体验。"]],
      ],
      quote: "秉持诚信、真实与卓越的精神，LuxurEat致力于为全球消费者提供一种既传承意大利传统，又具有前瞻性视野的美食体验。",
    ...
    "en-about": {
      ...
      image: images.aboutRoberto,
      intro: "The LuxurEat story begins with flavors passed down through generations at an Italian family table.",
      opening: [
      ...
      sections: [
        ...
        ["From Italy to the World", [
          "Today, LuxurEat is an international group specializing in truffles, caviar, and premium foods, with companies or operations in Italy, the United States, Thailand, and China, supported by partners and distribution channels across Europe, Asia, the Middle East, and the United States.",
          "The group includes TrufflEat, CaviarEat, LuxurEat, Ugolini Gourmet, and other brands and product lines, serving restaurants, retailers, distributors, and international food companies through product sales and commercial partnerships.",
          "Alongside its own brands, LuxurEat provides private-label and OEM services, including recipe development, packaging design, Italian production, and international export, helping partners turn an idea into a commercially viable solution for different markets.",
        ]],
        ["Tradition, Innovation, and a Global Vision", [
          "For LuxurEat, Made in Italy is more than a statement of origin. It represents respect for ingredients, craftsmanship, and culinary culture.",
          "Rooted in Italian food tradition, the brand also responds to health, sustainability, and the needs of international markets by developing plant-based, gluten-free, low-allergen, Halal, and Kosher-compliant solutions.",
          "From the memories of one Italian family table to a premium food business spanning countries and regions, LuxurEat continues to pursue one goal: bringing authentic Italian flavor, exceptional ingredients, and innovative products to the world, so that traditional cuisine can thrive in new markets and new ways of living.",
        ]],
      ],
      sectionMedia: [
        [
        ...
        [
          { src: images.aboutProducts, alt: "LuxurEat truffle product collection" },
          { src: images.aboutMap, alt: "LuxurEat global business map" },
        ],
        [
          { src: images.aboutCaviar, alt: "LuxurEat white sturgeon caviar" },
          { src: images.aboutShrimp, alt: "LuxurEat shrimp tartare products" },
          { src: images.aboutBurger, alt: "LuxurEat Mediterranean fish burger" },
        ],
      ],
    ...
    "en-harvest": {
      ...
      cardText: "Honoring Italian craftsmanship, selecting outstanding seasonal ingredients, and protecting flavor and quality through natural methods, LuxurEat expresses respect for the land, nature, and the future through responsible sourcing and packaging.\n\nLuxurEat is rooted in tradition, guided by selection, oriented toward health, and accountable to sustainability. From premium ingredients to preparation and packaging, every step remains faithful to Italian food culture while respecting the future of nature and its ingredients.",
      intro: "LuxurEat is an international group focused on gastronomy, specializing in truffles, caviar, and premium foods.",
      opening: ["The group grew from the experience accumulated through TrufflEat and gradually developed into a global enterprise active in the production, distribution, and development of gourmet foods. Family heritage, a passion for gastronomy, and an entrepreneurial vision came together to create LuxurEat."],
      sections: [
        ["Our Vision", ["LuxurEat's vision is rooted in a profound respect for Italian culinary tradition and built on three core principles: responsible innovation, tangible sustainability, and responsible sourcing.", { type: "quote", bold: [0, 2, 4], lines: ["Tradition", "We are deeply rooted in Italian food culture and value traditions, experience, and craftsmanship passed down through generations. Every product is carefully made by Italian artisans, reflecting close attention to quality, ingredients, and production methods.", "Innovation", "We continually develop health-oriented products, including detox, light, gluten-free, and allergen-free options, in response to consumers' different needs for healthier eating.", "Sustainability", "Through ethical and inclusive products and services, we promote respect for the environment, biodiversity, and food diversity. We support sustainable agriculture and responsible dietary choices, including Halal, Kosher, and vegan products."] }]],
        ["Our Philosophy", ["For LuxurEat, true gastronomy comes not only from precious ingredients, but also from a shared commitment to tradition, quality, health, and the environment. Our philosophy runs through every step, from ingredient selection and product preparation to the final packaging.", { type: "quote", bold: [0, 2, 4, 6], lines: ["History", "We honor recipes and production techniques passed down through generations of Italian masters. Tradition is not simply a repetition of the past, but experience and judgment refined over time, allowing ingredients to retain their original purity, layers, and depth.", "Selection", "Quality begins with ingredients. We maintain rigorous selection standards and pay close attention to origin, season, and natural condition. Only seasonal ingredients that meet our high standards enter the LuxurEat collection.", "Health", "We believe shelf life should never come at the expense of nutrition or natural flavor. We therefore favor natural preservation methods that extend product quality while retaining the ingredients' original nutrition, texture, and character as much as possible.", "Sustainability", "Every ingredient comes from the land and nature. Through ethical sourcing and more environmentally responsible packaging choices, we reduce our impact and express respect for the land, ecosystems, and the future through concrete action."] }, "These values guide every company decision, from selecting premium ingredients and supporting sustainable agriculture to upholding strict international food standards that are ethical and inclusive.", "With integrity, authenticity, and excellence, LuxurEat is committed to offering consumers around the world a gourmet experience that carries Italian tradition forward with a future-facing vision."]],
      ],
      quote: "With integrity, authenticity, and excellence, LuxurEat carries Italian tradition forward with a future-facing vision.",
