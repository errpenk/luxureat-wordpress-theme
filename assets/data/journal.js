(() => {
  ...
  const images = {
    ...
    aboutHeritageGift: asset("media/about/about-heritage-gift.webp"),
  ...
  const articles = {
    ...
    "zh-recipe-truffle-tagliolini": {
      ...
      recipe: {
        ...
        knowledge: { label: "为什么松露只需要一点？理解松露的香气与风味搭配", href: "blog.html?article=truffle-truffle-aroma-pairing" },
      },
    ...
    "en-recipe-truffle-tagliolini": {
      ...
      recipe: {
        ...
        knowledge: { label: "Why Does Truffle Often Need Only a Little? Understanding Aroma and Pairing", href: "blog.html?article=truffle-truffle-aroma-pairing" },
      },
