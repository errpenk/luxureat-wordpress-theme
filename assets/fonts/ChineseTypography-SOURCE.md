...
- Homepage critical subset: `LuxurEatZhiSong-home-subset.woff2` (navigation and first-screen copy only; the web subset remains the delayed fallback)
...
- Homepage subsets: `KingHwaOldSong-home-critical.woff2` covers homepage display text; `LuxurEatZhiSong-home-subset.woff2` covers first-screen navigation and body copy. Complete web subsets load later for below-the-fold glyphs.
