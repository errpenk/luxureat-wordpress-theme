...
<script defer src="<?php echo esc_url(get_template_directory_uri() . '/assets/data/academy.js?v=20260801-font-image-final-130'); ?>"></script>
<script defer src="<?php echo esc_url(get_template_directory_uri() . '/assets/js/academy.js?v=20260801-font-image-final-130'); ?>"></script>
