...
<script defer src="<?php echo esc_url(get_template_directory_uri() . '/assets/data/academy.js?v=20260803-recipe-layouts-144'); ?>"></script>
<script defer src="<?php echo esc_url(get_template_directory_uri() . '/assets/js/academy.js?v=20260803-recipe-layouts-144'); ?>"></script>
