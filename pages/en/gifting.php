...
<div class="group">
<div class="relative aspect-[4/5] overflow-hidden bg-surface-container-low mb-6">
<img loading="lazy" decoding="async" alt="LuxurEat chefs providing a professional foodservice supply solution" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cooperation-foodservice-chefs.jpg?v=20260803-cooperation-2'); ?>"/>
</div>
