...
<link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri() . '/assets/css/journal.css?v=20260811-related-gallery-fix-23'); ?>">
...
<img data-partnership-image role="button" tabindex="0" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/about/brand-promise/brand-promise-hero.webp'); ?>" alt="LuxurEat (露意膳) and partners at a food-tasting event">
