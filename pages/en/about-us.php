...
<!-- lux:seo:start -->
<title>About Us | LuxurEat</title>
<meta name="description" content="Discover LuxurEat's brand heritage, stories of place, quality promise and seasonal observations.">
<!-- lux:seo:end -->
<!-- lux:fonts:start -->
...
<link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri() . '/assets/css/journal.css?v=20260906-mobile-service-fixes-52'); ?>">
...
<header class="lux-header">
  ...
  <nav class="lux-nav" aria-label="navigation"><a href="<?php echo esc_url(luxureat_static_url('en', '')); ?>">Home</a><a class="active" href="<?php echo esc_url(luxureat_static_url('en/about-us', '')); ?>">About Us</a><a href="<?php echo esc_url(luxureat_static_url('en/new', '')); ?>">New Arrivals</a><a href="<?php echo esc_url(luxureat_static_url('en/product', '')); ?>">Products</a><a href="<?php echo esc_url(luxureat_static_url('en/recipe', '')); ?>">Recipe Art</a><a href="<?php echo esc_url(luxureat_static_url('en/brand', '')); ?>">Brand News</a><a href="<?php echo esc_url(luxureat_static_url('en/blog', '')); ?>">Blog</a><a href="<?php echo esc_url(luxureat_static_url('en/certification', '')); ?>">Certification</a><a href="<?php echo esc_url(luxureat_static_url('en/china-market-insights', '')); ?>">China Market</a><a href="<?php echo esc_url(luxureat_static_url('en/import-export-services', '')); ?>">China Services</a><a href="<?php echo esc_url(luxureat_static_url('en/cooperation', '')); ?>">Cooperation</a><a href="<?php echo esc_url(luxureat_static_url('en/contact', '')); ?>">Contact</a></nav>
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a href="<?php echo esc_url(luxureat_static_url('zh/about-us', '')); ?>">ZH</a><span>/</span><a class="active" href="#">EN</a></span>
...
<p>LuxurEat (露意膳) is a Chinese company established. It operates in China from Shanghai as part of the international LuxurEat (露意膳) Group. It is not a representative office; it is the local operating company for imports, distribution, customer service, and commercial development in China.</p>
</div>
</div>
</section>
...
<section class="lux-ingredient-standard-note" id="brand-promise" aria-label="Brand Promise: Ingredients we do not use">
...
<div class="lux-brand-promise-copy"><small>Brand Promise</small><h2>A promise made visible</h2><p>LuxurEat (露意膳) begins with authentic origin, transparent formulations, batch traceability and professional application, so every commitment can be verified in <a class="lux-context-link lux-brand-promise-link border-b transition-colors" href="<?php echo esc_url(luxureat_static_url('en/certification', '')); ?>">documents, products and service</a>.</p></div>
</div>
<div class="lux-brand-promise-grid">
<article class="lux-brand-promise-card"><img width="1000" height="1032" loading="eager" fetchpriority="low" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/about/brand-promise/brand-promise-traceability.webp'); ?>" alt="CaviarEat caviar product outside a specialist store"><div><svg class="lux-brand-promise-icon" viewBox="0 0 24 24" aria-hidden="true" translate="no"><path d="M20 10c0 5-8 12-8 12S4 15 4 10a8 8 0 1 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg><h3>Authentic Origin</h3><p>We build long-term relationships with trusted producers and verify origin, batches and supply-chain records.</p></div></article>
<article class="lux-brand-promise-card"><img width="828" height="551" loading="eager" fetchpriority="low" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/about/brand-promise/brand-promise-craft.webp'); ?>" alt="TrufflEat truffles and professional truffle slicers"><div><svg class="lux-brand-promise-icon" viewBox="0 0 24 24" aria-hidden="true" translate="no"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5Z"/><path d="M14 2v6h6"/><path d="m9 15 2 2 4-4"/></svg><h3>Transparent Traceability</h3><p>Ingredients, allergens, storage and transport records remain clear, accessible and verifiable.</p></div></article>
<article class="lux-brand-promise-card"><img srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/media/about/brand-promise/brand-promise-seasonal-720.webp'); ?> 720w, <?php echo esc_url(get_template_directory_uri() . '/assets/media/about/brand-promise/brand-promise-seasonal.webp'); ?> 976w" sizes="(max-width: 760px) 100vw, 25vw" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/about/brand-promise/brand-promise-seasonal-720.webp'); ?>" width="976" height="810" loading="eager" fetchpriority="low" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/about/brand-promise/brand-promise-seasonal.webp'); ?>" alt="White truffles presented in a seasonal display"><div><svg class="lux-brand-promise-icon" viewBox="0 0 24 24" aria-hidden="true" translate="no"><path d="m12 3-1.9 5.8a2 2 0 0 1-1.3 1.3L3 12l5.8 1.9a2 2 0 0 1 1.3 1.3L12 21l1.9-5.8a2 2 0 0 1 1.3-1.3L21 12l-5.8-1.9a2 2 0 0 1-1.3-1.3Z"/></svg><h3>Respect for Craft</h3><p>Measured processing and professional tools protect the true character of truffles, caviar and other fine ingredients.</p></div></article>
<article class="lux-brand-promise-card"><img srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/media/about/brand-promise/brand-promise-service-720.webp'); ?> 720w, <?php echo esc_url(get_template_directory_uri() . '/assets/media/about/brand-promise/brand-promise-service.webp'); ?> 1000w" sizes="(max-width: 760px) 100vw, 25vw" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/about/brand-promise/brand-promise-service-720.webp'); ?>" width="1000" height="1333" loading="eager" fetchpriority="low" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/about/brand-promise/brand-promise-service.webp'); ?>" alt="CaviarEat caviar tins and mother-of-pearl spoon"><div><svg class="lux-brand-promise-icon" viewBox="0 0 24 24" aria-hidden="true" translate="no"><path d="M20 13c0 5-3.5 7.5-8 9-4.5-1.5-8-4-8-9V5l8-3 8 3Z"/><path d="m9 12 2 2 4-4"/></svg><h3>Reliable Service</h3><p>Curated products, professional application and long-term support bring consistent quality to every table.</p></div></article>
</div>
</div>
<p>What we do not use is more than an exclusion list; it is LuxurEat’s (露意膳) baseline commitment to health, quality, and transparency. We carefully avoid additives of unclear origin, unnecessary function, or those that could conceal an ingredient’s natural character, while prioritizing clear formulations, traceable batches, and fully documented supply chains.</p>
<p>From origin certificates and ingredient specifications to allergen, production, storage, and transport records, every choice is supported by verifiable information. Individual formulas remain subject to their labels and technical documents; this comprehensive professional review helps foodservice teams and home users understand, use, and trust our products with confidence.</p>
</section>
<!-- Secondary Grid -->
