...
<link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri() . '/assets/css/journal.css?v=20260812-scroll-footer-group-65'); ?>">
...
<img width="987" height="1481" loading="lazy" decoding="async" class="w-full h-full object-cover" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/italian-caviar-market.webp'); ?>" alt="Italian caviar served with a mother-of-pearl spoon">
