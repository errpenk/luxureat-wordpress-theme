...
<!-- lux:seo:start -->
<title>Products | LuxurEat</title>
<meta name="description" content="Browse LuxurEat's selected premium Italian foods, truffle products, caviar and culinary collections.">
<!-- lux:seo:end -->
<!-- lux:fonts:start -->
...
<header class="lux-header">
  ...
  <nav class="lux-nav" aria-label="navigation"><a href="<?php echo esc_url(luxureat_static_url('en', '')); ?>">Home</a><a href="<?php echo esc_url(luxureat_static_url('en/about-us', '')); ?>">About Us</a><a href="<?php echo esc_url(luxureat_static_url('en/new', '')); ?>">New Arrivals</a><a class="active" href="<?php echo esc_url(luxureat_static_url('en/product', '')); ?>">Products</a><a href="<?php echo esc_url(luxureat_static_url('en/recipe', '')); ?>">Recipe Art</a><a href="<?php echo esc_url(luxureat_static_url('en/brand', '')); ?>">Brand News</a><a href="<?php echo esc_url(luxureat_static_url('en/blog', '')); ?>">Blog</a><a href="<?php echo esc_url(luxureat_static_url('en/certification', '')); ?>">Certification</a><a href="<?php echo esc_url(luxureat_static_url('en/china-market-insights', '')); ?>">China Market</a><a href="<?php echo esc_url(luxureat_static_url('en/import-export-services', '')); ?>">China Services</a><a href="<?php echo esc_url(luxureat_static_url('en/cooperation', '')); ?>">Cooperation</a><a href="<?php echo esc_url(luxureat_static_url('en/contact', '')); ?>">Contact</a></nav>
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">ZH</a><span>/</span><a class="active" href="#">EN</a></span>
...
<label class="lux-caviar-search"><svg class="lux-lucide" viewBox="0 0 24 24" aria-hidden="true"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg><input type="search" data-caviar-search placeholder="Search products" autocomplete="off" aria-label="Search products"><button type="button" class="lux-search-clear" data-caviar-search-clear aria-label="Clear search"><svg class="lux-lucide" viewBox="0 0 24 24" aria-hidden="true"><path d="m18 6-12 12"/><path d="m6 6 12 12"/></svg></button></label>
</div>
...
<div class="lux-product-count">Showing <strong data-caviar-count>47</strong> products</div>
...
<button type="button" data-caviar-filter-group="category" data-caviar-filter="caviar" aria-pressed="false"><span aria-hidden="true"></span>Caviar</button>
<button type="button" data-caviar-filter-group="category" data-caviar-filter="truffle" aria-pressed="false"><span aria-hidden="true"></span>Truffle</button>
<button type="button" data-caviar-filter-group="category" data-caviar-filter="pizza" aria-pressed="false"><span aria-hidden="true"></span>Pizza</button>
<button type="button" data-caviar-filter-group="category" data-caviar-filter="olive-oil" aria-pressed="false"><span aria-hidden="true"></span>Olive Oil</button>
<button type="button" data-caviar-filter-group="category" data-caviar-filter="pasta" aria-pressed="false"><span aria-hidden="true"></span>Italian Pasta</button>
<button type="button" data-caviar-filter-group="category" data-caviar-filter="gelato" aria-pressed="false"><span aria-hidden="true"></span>Italian Gelato</button>
</div></section>
...
<button type="button" data-caviar-filter-group="type" data-caviar-filter="pasta" aria-pressed="false"><span aria-hidden="true"></span>Pasta</button>
...
<a class="inline-flex px-12 py-4 border border-primary text-primary font-label-lg uppercase tracking-[0.2em] hover:bg-primary hover:text-on-primary transition-all duration-500 active:scale-95" href="<?php echo esc_url(luxureat_static_url('en/recipe', '')); ?>">Explore Recipes</a>
</div>
</section>
</main>
<!-- Footer -->
