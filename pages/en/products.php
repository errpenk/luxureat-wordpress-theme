...
<section class="lux-product-topic-bridge" aria-labelledby="product-topic-bridge-title-en">
<header><span>PRODUCT KNOWLEDGE</span><h2 id="product-topic-bridge-title-en">Understand the ingredient,<br><em>then choose the product.</em></h2><p>The catalogue presents confirmed formats; territory, flavour, nutrition, allergens and use are developed in the Knowledge Blog.</p></header>
<div><a href="<?php echo esc_url(luxureat_static_url('en/blog', '?topic=olive')); ?>"><strong>Italian extra-virgin olive oil</strong><span>Regions, cultivars, tasting, storage and recipes</span><b>Enter Olive Oil Academy ↗</b></a><a href="<?php echo esc_url(luxureat_static_url('en/blog', '?topic=gelato')); ?>"><strong>Italian Gelato &amp; Ugolini direction</strong><span>Culture, craft, professional use and pre-launch information</span><b>View Gelato topic ↗</b></a></div>
</section>
