...
<!-- lux:seo:start -->
<title>Cooperation | LuxurEat</title>
...
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/Spectral-Regular.woff2?v=20260906-mobile-service-fixes-52'); ?>" as="font" type="font/woff2" crossorigin>
...
<style data-lux-critical-fonts>@font-face{font-family:"Nyght Serif";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/NyghtSerif-Regular.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:swap}@font-face{font-family:"Spectral";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/Spectral-Regular.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:swap}@font-face{font-family:"Nyght Serif";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/NyghtSerif-RegularItalic.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:400;font-style:italic;font-display:swap}@font-face{font-family:"Nyght Serif";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/NyghtSerif-Bold.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:swap}@font-face{font-family:"Spectral";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/Spectral-Italic.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:400;font-style:italic;font-display:swap}@font-face{font-family:"Spectral";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/Spectral-Light.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:300;font-style:normal;font-display:swap}@font-face{font-family:"Spectral";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/Spectral-SemiBold.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:600;font-style:normal;font-display:swap}</style>
<!-- lux:fonts:end -->
...
<header class="lux-header">
  ...
  <nav class="lux-nav" aria-label="navigation"><a href="<?php echo esc_url(luxureat_static_url('en', '')); ?>">Home</a><a href="<?php echo esc_url(luxureat_static_url('en/about-us', '')); ?>">About Us</a><a href="<?php echo esc_url(luxureat_static_url('en/new', '')); ?>">New Arrivals</a><a href="<?php echo esc_url(luxureat_static_url('en/product', '')); ?>">Products</a><a href="<?php echo esc_url(luxureat_static_url('en/recipe', '')); ?>">Recipe Art</a><a href="<?php echo esc_url(luxureat_static_url('en/brand', '')); ?>">Brand News</a><a href="<?php echo esc_url(luxureat_static_url('en/blog', '')); ?>">Blog</a><a href="<?php echo esc_url(luxureat_static_url('en/certification', '')); ?>">Certification</a><a href="<?php echo esc_url(luxureat_static_url('en/china-market-insights', '')); ?>">China Market</a><a href="<?php echo esc_url(luxureat_static_url('en/import-export-services', '')); ?>">China Services</a><a class="active" href="<?php echo esc_url(luxureat_static_url('en/cooperation', '')); ?>">Cooperation</a><a href="<?php echo esc_url(luxureat_static_url('en/contact', '')); ?>">Contact</a></nav>
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a href="<?php echo esc_url(luxureat_static_url('zh/cooperation', '')); ?>">ZH</a><span>/</span><a class="active" href="#">EN</a></span>
...
<img srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-lead-caviar-mobile.webp'); ?> 720w, <?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-lead-caviar.jpg'); ?> 1200w" sizes="100vw" width="720" height="540" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-lead-caviar-mobile.webp'); ?>" class="lux-collab-mosaic-lead-image" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-lead-caviar.jpg'); ?>" alt="LuxurEat (露意膳) caviar products and hospitality partnership">
...
<img srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-feature-caviar-mobile.webp'); ?> 720w, <?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-feature-caviar.jpg'); ?> 1440w" sizes="100vw" width="720" height="720" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-feature-caviar-mobile.webp'); ?>" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-feature-caviar.jpg'); ?>" alt="LuxurEat (露意膳) caviar hospitality partnership">
</figure>
<figure data-partnership-image role="button" tabindex="0"><img srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-01-mobile.webp'); ?> 720w, <?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-01.jpg'); ?> 1280w" sizes="100vw" width="720" height="720" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-01-mobile.webp'); ?>" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-01.jpg'); ?>" alt="Preparing a caviar dish"></figure>
<figure data-partnership-image role="button" tabindex="0"><img srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-02-mobile.webp'); ?> 720w, <?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-02.webp'); ?> 1440w" sizes="100vw" width="720" height="742" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-02-mobile.webp'); ?>" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-02.webp'); ?>" alt="Caviar and seafood service"></figure>
<figure data-partnership-image role="button" tabindex="0"><img srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-03-mobile.webp'); ?> 720w, <?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-03.webp'); ?> 1440w" sizes="100vw" width="720" height="896" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-03-mobile.webp'); ?>" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-03.webp'); ?>" alt="Caviar product presentation"></figure>
<figure data-partnership-image role="button" tabindex="0"><img srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-04-mobile.webp'); ?> 720w, <?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-04.jpg'); ?> 1440w" sizes="100vw" width="720" height="900" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-04-mobile.webp'); ?>" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-gallery-04.jpg'); ?>" alt="Fresh black truffle presentation"></figure>
</section>
...
<img srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/partnership-solution-vodka-mobile.webp'); ?> 720w, <?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/partnership-solution-vodka.jpg'); ?> 1439w" sizes="100vw" width="720" height="720" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/partnership-solution-vodka-mobile.webp'); ?>" loading="lazy" decoding="async" alt="Truffle vodka private label and OEM production solution" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/partnership-solution-vodka.jpg'); ?>"/>
</div>
...
<div class="group">
<div class="relative aspect-[4/5] overflow-hidden bg-surface-container-low mb-6">
<img srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-wholesale-truffle-salt-mobile.webp'); ?> 720w, <?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-wholesale-truffle-salt.webp'); ?> 1440w" sizes="100vw" width="720" height="540" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-wholesale-truffle-salt-mobile.webp'); ?>" loading="lazy" decoding="async" alt="Black truffle salt wholesale and professional purchasing solution" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-wholesale-truffle-salt.webp'); ?>"/>
</div>
...
<div class="group">
<div class="relative aspect-[4/5] overflow-hidden bg-surface-container-low mb-6">
<img srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/partnership-solution-retail-bag-mobile.webp'); ?> 720w, <?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/partnership-solution-retail-bag.jpg'); ?> 1201w" sizes="100vw" width="720" height="480" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/partnership-solution-retail-bag-mobile.webp'); ?>" loading="lazy" decoding="async" alt="Truffle retail and international distribution solution" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/partnership-solution-retail-bag.jpg'); ?>"/>
</div>
...
<div class="group">
<div class="relative aspect-[4/5] overflow-hidden bg-surface-container-low mb-6">
<img width="640" height="960" loading="lazy" decoding="async" alt="LuxurEat chefs providing a professional foodservice supply solution" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cooperation-foodservice-chefs.jpg'); ?>"/>
</div>
...
<div class="group">
<div class="relative aspect-[4/5] overflow-hidden bg-surface-container-low mb-6">
<img srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/partnership-solution-white-truffle-gift-mobile.webp'); ?> 720w, <?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/partnership-solution-white-truffle-gift.jpg'); ?> 886w" sizes="100vw" width="720" height="720" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/partnership-solution-white-truffle-gift-mobile.webp'); ?>" loading="lazy" decoding="async" alt="White truffle corporate gifting and brand customization solution" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/partnership-solution-white-truffle-gift.jpg'); ?>"/>
</div>
...
<img width="612" height="407" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-channel-truffles-in-hand.webp'); ?>" alt="Selected black truffles held in both hands">
<img width="836" height="550" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-channel-truffle-products.webp'); ?>" alt="Black truffles and truffle oil product selection">
<img srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-channel-truffle-sauce-mobile.webp'); ?> 720w, <?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-channel-truffle-sauce.webp'); ?> 1440w" sizes="100vw" width="720" height="480" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-channel-truffle-sauce-mobile.webp'); ?>" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-channel-truffle-sauce.webp'); ?>" alt="TrufflEAT black truffle sauce products">
<img width="668" height="668" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/partnership-solution-caviar-service.jpg'); ?>" alt="CaviarEat professional caviar service">
</div>
</div>
<section class="lux-channel-showcase" aria-label="Professional channel support">
<figure class="lux-channel-feature"><img srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-importer-partnership-mobile.webp'); ?> 720w, <?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-importer-partnership.webp'); ?> 1496w" sizes="100vw" width="720" height="493" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-importer-partnership-mobile.webp'); ?>" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-importer-partnership.webp'); ?>" alt="LuxurEat (露意膳) channel partnership"></figure>
...
<figure><figcaption>Overseas Contact</figcaption><img width="512" height="507" class="lux-importer-qr" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/luxureat-contact-qr-transparent.webp'); ?>" alt="LuxurEat (露意膳) overseas contact QR code"></figure>
<figure><figcaption>Domestic Contact</figcaption><img width="600" height="600" class="lux-importer-qr" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/luxureat-domestic-contact-qr-transparent.webp'); ?>" alt="LuxurEat (露意膳) domestic contact WeChat QR code"></figure>
</div>
</article>
</div>
</div>
...
<footer class="lux-footer">
  <div class="lux-footer-grid">
    ...
    <nav><a href="<?php echo esc_url(luxureat_static_url('en', '')); ?>">Home</a><a href="<?php echo esc_url(luxureat_static_url('en/about-us', '')); ?>">About Us</a><a href="<?php echo esc_url(luxureat_static_url('en/new', '')); ?>">New Arrivals</a><a href="<?php echo esc_url(luxureat_static_url('en/product', '')); ?>">Products</a><a href="<?php echo esc_url(luxureat_static_url('en/recipe', '')); ?>">Recipe Art</a><a href="<?php echo esc_url(luxureat_static_url('en/brand', '')); ?>">Brand News</a><a href="<?php echo esc_url(luxureat_static_url('en/blog', '')); ?>">Blog</a><a href="<?php echo esc_url(luxureat_static_url('en/certification', '')); ?>">Certification</a><a href="<?php echo esc_url(luxureat_static_url('en/china-market-insights', '')); ?>">China Market</a><a href="<?php echo esc_url(luxureat_static_url('en/import-export-services', '')); ?>">China Services</a><a href="<?php echo esc_url(luxureat_static_url('en/cooperation', '')); ?>">Cooperation</a><a href="<?php echo esc_url(luxureat_static_url('en/contact', '')); ?>">Contact</a></nav>
