...
<!-- lux:seo:end -->
<!-- lux:fonts:start -->
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/NyghtSerif-Regular.woff2?v=20260812-mobile-cert-hero-36'); ?>" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/Spectral-Regular.woff2?v=20260812-mobile-cert-hero-36'); ?>" as="font" type="font/woff2" crossorigin>
<style data-lux-critical-fonts>@font-face{font-family:"Nyght Serif";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/NyghtSerif-Regular.woff2?v=20260812-mobile-cert-hero-36'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:block}@font-face{font-family:"Spectral";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/Spectral-Regular.woff2?v=20260812-mobile-cert-hero-36'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:block}@font-face{font-family:"Nyght Serif";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/NyghtSerif-RegularItalic.woff2?v=20260812-mobile-cert-hero-36'); ?>") format("woff2");font-weight:400;font-style:italic;font-display:block}@font-face{font-family:"Nyght Serif";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/NyghtSerif-Bold.woff2?v=20260812-mobile-cert-hero-36'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:block}@font-face{font-family:"Spectral";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/Spectral-Italic.woff2?v=20260812-mobile-cert-hero-36'); ?>") format("woff2");font-weight:400;font-style:italic;font-display:block}@font-face{font-family:"Spectral";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/Spectral-Light.woff2?v=20260812-mobile-cert-hero-36'); ?>") format("woff2");font-weight:300;font-style:normal;font-display:block}@font-face{font-family:"Spectral";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/Spectral-SemiBold.woff2?v=20260812-mobile-cert-hero-36'); ?>") format("woff2");font-weight:600;font-style:normal;font-display:block}</style>
<!-- lux:fonts:end -->
<link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri() . '/assets/css/tailwind-site.css?v=20260812-mobile-cert-hero-36'); ?>">
<style>
...
<link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri() . '/assets/css/newsletter.css?v=20260812-mobile-cert-hero-36'); ?>">
...
<img data-cert-media-slide loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-system-truffle-sizing.jpg'); ?>" alt="Truffle ingredient sizing">
...
<img data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-morel-selection-mobile.webp'); ?>" data-cert-media-slide loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-morel-selection.webp'); ?>" alt="Fresh morel ingredient selection">
...
<figure data-cert-hover-image data-partnership-image role="button" tabindex="0"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-gallery-truffle-hand.webp'); ?>" alt="Selected black truffle held by hand"></figure>
...
<img data-cert-partnership-main data-partnership-image loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-01.webp'); ?>" alt="TruffleEat airport bar and restaurant partnership space">
</figure>
<div class="lux-cert-partnership-thumbs" aria-label="Select a partnership image">
<button type="button" hidden data-cert-partnership-thumb data-index="0" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-01.webp'); ?>" data-alt="TruffleEat airport bar and restaurant partnership space" aria-label="View partnership image 1"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-01.webp'); ?>" alt=""></button>
<button type="button" data-cert-partnership-thumb data-index="1" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-02.webp'); ?>" data-alt="Guests enjoying an airport hospitality lounge" aria-label="View partnership image 2"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-02.webp'); ?>" alt=""></button>
<button type="button" data-cert-partnership-thumb data-index="2" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-03.webp'); ?>" data-alt="Front view of the TruffleEat airport bar and restaurant" aria-label="View partnership image 3"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-03.webp'); ?>" alt=""></button>
<button type="button" data-cert-partnership-thumb data-index="3" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-04.webp'); ?>" data-alt="Open TruffleEat airport bar and restaurant" aria-label="View partnership image 4"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-04.webp'); ?>" alt=""></button>
...
<button type="button" data-cert-partnership-thumb data-index="5" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-06.webp'); ?>" data-alt="Interior of a TruffleEat bar and restaurant concept" aria-label="View partnership image 6"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-06.webp'); ?>" alt=""></button>
<button type="button" data-cert-partnership-thumb data-index="6" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-07.webp'); ?>" data-alt="Panoramic TruffleEat bar and restaurant concept" aria-label="View partnership image 7"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-07.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="7" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-08.webp'); ?>" data-alt="TruffleEat restaurant terrace concept" aria-label="View partnership image 8"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-08.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="8" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-09.webp'); ?>" data-alt="TruffleEat restaurant interior concept" aria-label="View partnership image 9"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-09.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="9" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-10.webp'); ?>" data-alt="Two-level TruffleEat hospitality concept" aria-label="View partnership image 10"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-10.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="10" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-11.webp'); ?>" data-alt="Golden TruffleEat casino bar concept" aria-label="View partnership image 11"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-11.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="11" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-12.webp'); ?>" data-alt="TruffleEat cruise hospitality proposal" aria-label="View partnership image 12"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-12.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="12" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-13.webp'); ?>" data-alt="TruffleEat ocean-view cruise bar" aria-label="View partnership image 13"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-13.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="13" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-14.webp'); ?>" data-alt="TruffleEat hotel bar space" aria-label="View partnership image 14"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-14.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="14" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-15.webp'); ?>" data-alt="Guests dining in a TruffleEat hotel restaurant" aria-label="View partnership image 15"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-15.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="15" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-16.webp'); ?>" data-alt="TruffleEat hotel restaurant in service" aria-label="View partnership image 16"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-16.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="16" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-17.webp'); ?>" data-alt="TruffleEat street-food truck concept" aria-label="View partnership image 17"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-17.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="17" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-18.webp'); ?>" data-alt="Vintage TruffleEat street-food vehicle concept" aria-label="View partnership image 18"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-18.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="18" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-19.webp'); ?>" data-alt="TruffleEat train-station bar and restaurant" aria-label="View partnership image 19"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-19.webp'); ?>" alt=""></button>
</div>
</div>
</section>
</main>
