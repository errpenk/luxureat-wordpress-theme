...
<!-- lux:seo:start -->
<title>关于我们 | LuxurEat（露意膳）</title>
<meta name="description" content="了解 LuxurEat（露意膳）的品牌传承、产地故事、品质承诺与时令观察。">
<!-- lux:seo:end -->
<!-- lux:fonts:start -->
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-journal-critical.woff2?v=20260906-mobile-service-fixes-52'); ?>" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-journal-critical.woff2?v=20260906-mobile-service-fixes-52'); ?>" as="font" type="font/woff2" crossorigin>
...
<style data-lux-critical-fonts>@font-face{font-family:"KingHwa Page Critical";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-journal-critical.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:block}@font-face{font-family:"KingHwa Old Song Site";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-site.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:block}@font-face{font-family:"ZhiSong Page Critical";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-journal-critical.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:swap}@font-face{font-family:"LuxurEat ZhiSong Site";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-site.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:swap}html[lang^="zh"]{--lux-page-heading:"KingHwa Page Critical","KingHwa Old Song Site"!important;--lux-zh-headline:"KingHwa Page Critical","KingHwa Old Song Site"!important;--lux-zh-body:"ZhiSong Page Critical","LuxurEat ZhiSong Site"!important}</style>
<!-- lux:fonts:end -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="#">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/about-us', '')); ?>">EN</a></span>
...
<span class="material-symbols-outlined text-primary animate-bounce" data-original-icon="arrow_downward" data-icon="arrow_downward" aria-hidden="true" translate="no"></span>
</a>
</div>
</div>
</section>
...
<h2>扎根中国的本地运营主体</h2>
<p>LuxurEat（露意膳） 是一家在中国设立并以上海为运营中心的中国公司，隶属于 LuxurEat（露意膳） 国际集团。它不是海外品牌的代表处，而是面向中国市场直接开展进口、分销、客户服务与商业发展的本地运营主体。</p>
</div>
</div>
</section>
...
<a class="inline-flex items-center gap-4 group font-label-lg text-label-lg uppercase tracking-widest text-on-surface hover:text-primary transition-colors" href="#" data-reader-open="zh-harvest">
                        阅读详情
                        <span class="material-symbols-outlined text-primary group-hover:translate-x-2 transition-transform" data-original-icon="arrow_forward" data-icon="arrow_forward" aria-hidden="true" translate="no"></span>
</a>
</div>
</div>
</section>
...
<div class="lux-brand-promise-copy"><small>品牌承诺</small><h2>以透明与责任，守护每一次选择</h2><p>LuxurEat（露意膳）坚持从真实产地、清晰配方、批次追溯与专业应用出发，让每一项承诺都能由<a class="lux-context-link lux-brand-promise-link border-b transition-colors" href="<?php echo esc_url(luxureat_static_url('zh/certification', '')); ?>">文件、产品和实际服务</a>验证。</p></div>
</div>
...
<p>从产地证明、成分文件、过敏原信息到生产与储运记录，我们以可验证的资料支持每一次选择。具体配方仍以产品标签及技术文件为准；这套全面而专业的审查方式，让专业餐饮与家庭用户都能更安心地理解、使用并信任我们的产品。</p>
</section>
...
<div class="block">
<a class="lux-narrative-link" href="#archive" data-reader-archive>浏览往期<span class="material-symbols-outlined" data-icon="arrow_forward" aria-hidden="true" translate="no"></span></a>
</div>
</div>
...
<img width="1080" height="650" loading="lazy" decoding="async" class="w-full h-full object-cover" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/about-truffle-products.webp'); ?>">
...
<img width="854" height="590" loading="lazy" decoding="async" class="w-full h-full object-cover" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/academy/caviar-processing-04.webp'); ?>">
