...
<!-- lux:seo:end -->
<!-- lux:fonts:start -->
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-certification-critical.woff2?v=20260812-scroll-footer-group-65'); ?>" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-certification-critical.woff2?v=20260812-scroll-footer-group-65'); ?>" as="font" type="font/woff2" crossorigin>
...
<img width="646" height="646" data-cert-media-slide loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-system-truffle-sizing.jpg'); ?>" alt="松露原料规格测量">
...
<figure data-cert-hover-image data-partnership-image role="button" tabindex="0"><img width="833" height="834" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-gallery-truffle-hand.webp'); ?>" alt="手持精选黑松露"></figure>
...
<header><h2 id="award-proofs-title-zh">集团旗下产品获奖记录</h2><p><a href="https://luxureat.com/" target="_blank" rel="noopener noreferrer">LuxurEat（露意膳）</a>旗下品牌包括 <a href="https://caviareat.it/" target="_blank" rel="noopener noreferrer">CaviarEat</a>、<a href="https://truffleat.com/" target="_blank" rel="noopener noreferrer">TrufflEat</a> 与 <a href="https://ugolinigourmet.it/" target="_blank" rel="noopener noreferrer">Ugolini</a>。从原料选择到生产工艺，每一项国际奖项都记录着我们对品质的长期坚持，也体现了旗下产品在风味、创新与稳定性方面的出色表现。</p></header>
...
<figure><button type="button" data-cert-award-open="<?php echo esc_url(get_template_directory_uri() . '/assets/media/certifications/brcgs.png'); ?>" aria-label="放大查看奖项图片 3"><img width="245" height="78" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/certifications/brcgs.png'); ?>" alt="奖项记录占位图片 3"></button></figure>
<figure><button type="button" data-cert-award-open="<?php echo esc_url(get_template_directory_uri() . '/assets/media/certifications/ifs.png'); ?>" aria-label="放大查看奖项图片 4"><img width="377" height="134" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/certifications/ifs.png'); ?>" alt="奖项记录占位图片 4"></button></figure>
<figure><button type="button" data-cert-award-open="<?php echo esc_url(get_template_directory_uri() . '/assets/media/certifications/fda-2026.png'); ?>" aria-label="放大查看奖项图片 5"><img width="330" height="154" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/certifications/fda-2026.png'); ?>" alt="奖项记录占位图片 5"></button></figure>
</div>
</section>
<section class="lux-cert-leadership" aria-labelledby="cert-leadership-title-zh">
<header>
<span>泰国市场 · 鱼子酱与松露</span>
<h2 id="cert-leadership-title-zh">行业领先</h2>
...
<button type="button" data-cert-partnership-thumb data-index="6" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-07.webp'); ?>" data-alt="TruffleEat 酒吧与餐厅概念空间全景" aria-label="查看合作图片 7"><img width="1800" height="1009" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-07.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="7" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-08.webp'); ?>" data-alt="TruffleEat 餐厅露台概念空间" aria-label="查看合作图片 8"><img width="1024" height="576" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-08.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="8" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-09.webp'); ?>" data-alt="TruffleEat 餐厅室内概念设计" aria-label="查看合作图片 9"><img width="1024" height="575" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-09.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="9" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-10.webp'); ?>" data-alt="TruffleEat 双层餐饮空间概念" aria-label="查看合作图片 10"><img width="1024" height="574" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-10.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="10" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-11.webp'); ?>" data-alt="TruffleEat 娱乐场金色酒吧概念" aria-label="查看合作图片 11"><img width="1600" height="1067" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-11.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="11" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-12.webp'); ?>" data-alt="TruffleEat 邮轮餐饮空间方案" aria-label="查看合作图片 12"><img width="1024" height="633" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-12.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="12" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-13.webp'); ?>" data-alt="TruffleEat 邮轮海景酒吧" aria-label="查看合作图片 13"><img width="852" height="568" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-13.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="13" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-14.webp'); ?>" data-alt="TruffleEat 酒店酒吧空间" aria-label="查看合作图片 14"><img width="768" height="536" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-14.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="14" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-15.webp'); ?>" data-alt="TruffleEat 酒店餐厅宾客体验" aria-label="查看合作图片 15"><img width="1199" height="800" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-15.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="15" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-16.webp'); ?>" data-alt="TruffleEat 酒店餐厅运营场景" aria-label="查看合作图片 16"><img width="1180" height="800" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-16.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="16" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-17.webp'); ?>" data-alt="TruffleEat 街头餐车概念" aria-label="查看合作图片 17"><img width="1800" height="1350" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-17.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="17" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-18.webp'); ?>" data-alt="TruffleEat 复古街头餐车方案" aria-label="查看合作图片 18"><img width="1800" height="1352" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-18.webp'); ?>" alt=""></button>
<button type="button" hidden data-cert-partnership-thumb data-index="18" data-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-19.webp'); ?>" data-alt="TruffleEat 火车站酒吧与餐厅" aria-label="查看合作图片 19"><img width="768" height="509" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-partnership-gallery-19.webp'); ?>" alt=""></button>
</div>
</div>
</section>
</main>
