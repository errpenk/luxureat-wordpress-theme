...
<!-- lux:seo:start -->
<title>冬季黑松露酱 · 180 g | LuxurEat</title>
<meta name="description" content="含2.9%冬季黑松露与5%黑喇叭菌，层次深沉且不含麸质，适合精细餐饮调味。 产品规格为 180 g。">
<!-- lux:seo:end -->
<!-- lux:fonts:start -->
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-caviar-critical.woff2?v=20260812-mobile-fast-46'); ?>" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-caviar-critical.woff2?v=20260812-mobile-fast-46'); ?>" as="font" type="font/woff2" crossorigin>
<style data-lux-critical-fonts>@font-face{font-family:"KingHwa Page Critical";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-caviar-critical.woff2?v=20260812-mobile-fast-46'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:swap}@font-face{font-family:"KingHwa Old Song Site";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-site.woff2?v=20260812-mobile-fast-46'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:swap}@font-face{font-family:"ZhiSong Page Critical";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-caviar-critical.woff2?v=20260812-mobile-fast-46'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:swap}@font-face{font-family:"LuxurEat ZhiSong Site";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-site.woff2?v=20260812-mobile-fast-46'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:swap}html[lang^="zh"]{--lux-page-heading:"KingHwa Page Critical","Songti SC",serif!important;--lux-zh-headline:"KingHwa Page Critical","Songti SC",serif!important;--lux-zh-body:"ZhiSong Page Critical","Songti SC",serif!important}html.lux-full-fonts[lang^="zh"]{--lux-page-heading:"KingHwa Page Critical","KingHwa Old Song Site","Songti SC",serif!important;--lux-zh-headline:"KingHwa Page Critical","KingHwa Old Song Site","Songti SC",serif!important;--lux-zh-body:"ZhiSong Page Critical","LuxurEat ZhiSong Site","Songti SC",serif!important}</style>
<!-- lux:fonts:end -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="#">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/product/winter-black-truffle-sauce-180g')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">系列产品</a><span aria-hidden="true">/</span><span aria-current="page">冬季黑松露酱 · 180 g</span></nav><article class="lux-reader-layout lux-product-seo-page"><div class="lux-reader-rule"></div><section class="lux-reader-hero"><div class="lux-reader-hero-copy"><div class="lux-reader-meta-grid"><span>复合调味品</span><span>180 g</span><span>APPENNINO FOOD GROUP SPA</span></div><h1 id="lux-reader-title">冬季黑松露酱 · 180 g</h1><p class="lux-reader-summary">含2.9%冬季黑松露与5%黑喇叭菌，层次深沉且不含麸质，适合精细餐饮调味。 产品规格为 180 g。中国注册号：CITA28052410120158，注册有效期至 2029-10-12。</p></div><figure class="lux-reader-cover"><img width="834" height="1200" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/products/appennino/product-21.webp'); ?>" alt="冬季黑松露酱 · 180 g"></figure></section><section class="lux-reader-content"><aside class="lux-reader-aside"><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">返回产品系列</a></aside><div class="lux-reader-copy"><section class="lux-reader-section"><h2>产品信息</h2><dl class="lux-seo-facts"><div><dt>产品类型</dt><dd>复合调味品</dd></div><div><dt>配料</dt><dd>双孢蘑菇（双孢菇）50%、橄榄油、鸡油菌（黑喇叭菌）5%、冬季黑松露（黑孢块菌）2.9%、天然黑松露食用香料、食用盐；不含麸质。</dd></div><div><dt>致敏提醒</dt><dd>除对配料过敏或不耐受者外，所有人群均可食用。</dd></div><div><dt>原产国</dt><dd>意大利</dd></div><div><dt>进口商</dt><dd>露意膳（上海）贸易有限公司</dd></div><div><dt>进口商地址</dt><dd>上海市金山区枫泾镇曹黎路38弄19号5312室</dd></div><div><dt>贮存条件</dt><dd>置于阴凉干燥处；开封后需冷藏保存。</dd></div><div><dt>境外生产企业注册编号</dt><dd>CITA28052410120158</dd></div><div><dt>营养成分</dt><dd>每100克：能量1562千焦，蛋白质1.9克，脂肪40.2克，碳水化合物2.7克，糖0克，膳食纤维3.7克，钠1480毫克。</dd></div></dl></section></div></section></article></main>
<!-- lux:footer:start -->
