...
<!-- lux:seo:start -->
<title>U型长面 · 12 × 500 g | LuxurEat</title>
<meta name="description" content="采用 100% 意大利硬质小麦粗面粉和当地纯净泉水制成，保留传统 U 型长面造型。青铜模具拉制赋予面体粗糙多孔的表面，并经 40–45°C 低温慢干 24–48 小时。">
<!-- lux:seo:end -->
<!-- lux:fonts:start -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('product/spaghetti-ad-archetto')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/product/spaghetti-ad-archetto')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">系列产品</a><span aria-hidden="true">/</span><span aria-current="page">U型长面 · 12 × 500 g</span></nav><article class="lux-reader-layout lux-product-seo-page"><div class="lux-reader-rule"></div><section class="lux-reader-hero"><div class="lux-reader-hero-copy"><div class="lux-reader-meta-grid"><span>面食</span><span>12 × 500 g</span><span>Pastificio Strampelli</span></div><h1 id="lux-reader-title">U型长面 · 12 × 500 g</h1><p class="lux-reader-summary">采用 100% 意大利硬质小麦粗面粉和当地纯净泉水制成，保留传统 U 型长面造型。青铜模具拉制赋予面体粗糙多孔的表面，并经 40–45°C 低温慢干 24–48 小时。</p></div><figure class="lux-reader-cover"><img width="399" height="1181" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/products/pasta/spaghetti-ad-archetto.webp'); ?>" alt="U型长面 · 12 × 500 g"></figure></section><section class="lux-reader-content"><aside class="lux-reader-aside"><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">返回产品系列</a></aside><div class="lux-reader-copy"><section class="lux-reader-section"><h2>产品信息</h2><dl class="lux-seo-facts"><div><dt>产品类型</dt><dd>面食</dd></div><div><dt>产品编号</dt><dd>ST016</dd></div><div><dt>包装规格</dt><dd>12 × 500 g</dd></div><div><dt>建议烹饪时间</dt><dd>8–10 分钟</dd></div><div><dt>主要配料</dt><dd>100% 意大利硬质小麦粗面粉；当地泉水</dd></div><div><dt>工艺</dt><dd>青铜模具拉制；40–45°C 低温慢干 24–48 小时</dd></div><div><dt>生产商</dt><dd>Pastificio Strampelli</dd></div><div><dt>商品编码 / EAN</dt><dd>8056326390167</dd></div></dl></section></div></section></article></main>
<!-- lux:footer:start -->
