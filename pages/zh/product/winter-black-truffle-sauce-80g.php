...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('product/winter-black-truffle-sauce-80g')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/product/winter-black-truffle-sauce-80g')); ?>">EN</a></span>
