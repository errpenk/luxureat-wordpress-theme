...
<!-- lux:seo:start -->
<title>松露蜂蜜 · 170 g | LuxurEat</title>
<meta name="description" content="以99%洋槐蜜融合白松露风味，适合搭配奶酪、烤肉、甜点与礼赠组合。 产品规格为 170 g。">
<!-- lux:seo:end -->
<!-- lux:fonts:start -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="#">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/product/truffle-honey-170g')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">系列产品</a><span aria-hidden="true">/</span><span aria-current="page">松露蜂蜜 · 170 g</span></nav><article class="lux-reader-layout lux-product-seo-page"><div class="lux-reader-rule"></div><section class="lux-reader-hero"><div class="lux-reader-hero-copy"><div class="lux-reader-meta-grid"><span>复合调味品</span><span>170 g</span><span>APPENNINO FOOD GROUP SPA</span></div><h1 id="lux-reader-title">松露蜂蜜 · 170 g</h1><p class="lux-reader-summary">以99%洋槐蜜融合白松露风味，适合搭配奶酪、烤肉、甜点与礼赠组合。 产品规格为 170 g。中国注册号：CITA28052410120158，注册有效期至 2029-10-12。</p></div><figure class="lux-reader-cover"><img width="800" height="1200" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/products/appennino/product-10.webp'); ?>" alt="松露蜂蜜 · 170 g"></figure></section><section class="lux-reader-content"><aside class="lux-reader-aside"><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">返回产品系列</a></aside><div class="lux-reader-copy"><section class="lux-reader-section"><h2>产品信息</h2><dl class="lux-seo-facts"><div><dt>产品类型</dt><dd>复合调味品</dd></div><div><dt>配料</dt><dd>洋槐蜜99%、食用香料、春季白松露干（白孢块菌）0.05%。</dd></div><div><dt>致敏提醒</dt><dd>除对配料过敏或不耐受者外，所有人群均可食用。</dd></div><div><dt>原产国</dt><dd>意大利</dd></div><div><dt>进口商</dt><dd>露意膳（上海）贸易有限公司</dd></div><div><dt>进口商地址</dt><dd>上海市金山区枫泾镇曹黎路38弄19号5312室</dd></div><div><dt>贮存条件</dt><dd>置于阴凉干燥处。</dd></div><div><dt>境外生产企业注册编号</dt><dd>CITA28052410120158</dd></div><div><dt>营养成分</dt><dd>每100克：能量1379千焦，蛋白质0克，脂肪0克，碳水化合物81.1克，糖80.8克，膳食纤维0克，钠20毫克。</dd></div></dl></section></div></section></article></main>
<!-- lux:footer:start -->
