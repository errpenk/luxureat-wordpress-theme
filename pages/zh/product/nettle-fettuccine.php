...
<!-- lux:seo:start -->
<title>荨麻宽面 · 250 g | LuxurEat</title>
<meta name="description" content="加入 3.2% 荨麻的鸡蛋宽面，具有独特的草本风味与自然色泽。以硬质小麦粗面粉和鸡蛋为基础，经低温缓慢干燥。">
<!-- lux:seo:end -->
<!-- lux:fonts:start -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('product/nettle-fettuccine')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/product/nettle-fettuccine')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">系列产品</a><span aria-hidden="true">/</span><span aria-current="page">荨麻宽面 · 250 g</span></nav><article class="lux-reader-layout lux-product-seo-page"><div class="lux-reader-rule"></div><section class="lux-reader-hero"><div class="lux-reader-hero-copy"><div class="lux-reader-meta-grid"><span>面食</span><span>250 g / 4 人份</span><span>Marcozzi di Campofilone</span></div><h1 id="lux-reader-title">荨麻宽面 · 250 g</h1><p class="lux-reader-summary">加入 3.2% 荨麻的鸡蛋宽面，具有独特的草本风味与自然色泽。以硬质小麦粗面粉和鸡蛋为基础，经低温缓慢干燥。</p></div><figure class="lux-reader-cover"><img width="750" height="222" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/products/pasta/nettle-fettuccine.webp'); ?>" alt="荨麻宽面 · 250 g"></figure></section><section class="lux-reader-content"><aside class="lux-reader-aside"><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">返回产品系列</a></aside><div class="lux-reader-copy"><section class="lux-reader-section"><h2>产品信息</h2><dl class="lux-seo-facts"><div><dt>产品类型</dt><dd>面食</dd></div><div><dt>产品编号</dt><dd>M0018</dd></div><div><dt>包装规格</dt><dd>250 g / 4 人份</dd></div><div><dt>建议烹饪时间</dt><dd>2–3 分钟</dd></div><div><dt>尺寸</dt><dd>0.7/0.8 mm × 4 mm；长 45–55 cm</dd></div><div><dt>主要配料</dt><dd>硬质小麦粗面粉、鸡蛋 30.3%、荨麻 3.2%</dd></div><div><dt>工艺</dt><dd>粗糙多孔、缓慢干燥</dd></div><div><dt>生产商</dt><dd>Marcozzi di Campofilone（魔蔻滋）</dd></div></dl></section></div></section></article></main>
<!-- lux:footer:start -->
