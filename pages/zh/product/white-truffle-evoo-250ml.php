...
<!-- lux:seo:start -->
<title>白松露特级初榨橄榄油 · 250 ml | LuxurEat</title>
<meta name="description" content="以特级初榨橄榄油、0.2%春季白松露干和食用香料调制，兼具橄榄油果香与白松露香气。 产品规格为 250 ml。">
<!-- lux:seo:end -->
<!-- lux:fonts:start -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="#">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/product/white-truffle-evoo-250ml')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">系列产品</a><span aria-hidden="true">/</span><span aria-current="page">白松露特级初榨橄榄油 · 250 ml</span></nav><article class="lux-reader-layout lux-product-seo-page"><div class="lux-reader-rule"></div><section class="lux-reader-hero"><div class="lux-reader-hero-copy"><div class="lux-reader-meta-grid"><span>调味油</span><span>250 ml</span><span>APPENNINO FOOD GROUP SPA</span></div><h1 id="lux-reader-title">白松露特级初榨橄榄油 · 250 ml</h1><p class="lux-reader-summary">以特级初榨橄榄油、0.2%春季白松露干和食用香料调制，兼具橄榄油果香与白松露香气。 产品规格为 250 ml。中国注册号：CITA06022511070074，注册有效期至 2029-10-12。</p></div><figure class="lux-reader-cover"><img width="800" height="1200" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/products/appennino/product-03.webp'); ?>" alt="白松露特级初榨橄榄油 · 250 ml"></figure></section><section class="lux-reader-content"><aside class="lux-reader-aside"><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">返回产品系列</a></aside><div class="lux-reader-copy"><section class="lux-reader-section"><h2>产品信息</h2><dl class="lux-seo-facts"><div><dt>产品类型</dt><dd>调味油</dd></div><div><dt>配料</dt><dd>特级初榨橄榄油、春季白松露干（白孢块菌）0.2%、食用香料。</dd></div><div><dt>致敏提醒</dt><dd>除对配料过敏或不耐受者外，所有人群均可食用。</dd></div><div><dt>原产国</dt><dd>意大利</dd></div><div><dt>进口商</dt><dd>露意膳（上海）贸易有限公司</dd></div><div><dt>进口商地址</dt><dd>上海市金山区枫泾镇曹黎路38弄19号5312室</dd></div><div><dt>贮存条件</dt><dd>避光、避热保存。</dd></div><div><dt>境外生产企业注册编号</dt><dd>CITA06022511070074</dd></div><div><dt>营养成分</dt><dd>每100毫升：能量3382千焦，蛋白质0克，脂肪91.4克，碳水化合物0克，糖0克，膳食纤维0克，钠500毫克。</dd></div></dl></section></div></section></article></main>
<!-- lux:footer:start -->
