...
<!-- lux:seo:start -->
<title>整颗夏季黑松露 · 275 g | LuxurEat</title>
<meta name="description" content="整颗夏季黑松露以水和食用盐保存，便于切片、刨削或加入酱汁，保留完整食材形态。 产品规格为 275 g。">
<!-- lux:seo:end -->
<!-- lux:fonts:start -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="#">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/product/whole-summer-truffles-275g')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">系列产品</a><span aria-hidden="true">/</span><span aria-current="page">整颗夏季黑松露 · 275 g</span></nav><article class="lux-reader-layout lux-product-seo-page"><div class="lux-reader-rule"></div><section class="lux-reader-hero"><div class="lux-reader-hero-copy"><div class="lux-reader-meta-grid"><span>食用菌罐头</span><span>275 g</span><span>APPENNINO FOOD GROUP SPA</span></div><h1 id="lux-reader-title">整颗夏季黑松露 · 275 g</h1><p class="lux-reader-summary">整颗夏季黑松露以水和食用盐保存，便于切片、刨削或加入酱汁，保留完整食材形态。 产品规格为 275 g。中国注册号：CITA19012411040130，注册有效期至 2029-11-04。</p></div><figure class="lux-reader-cover"><img width="800" height="1200" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/products/appennino/product-17.webp'); ?>" alt="整颗夏季黑松露 · 275 g"></figure></section><section class="lux-reader-content"><aside class="lux-reader-aside"><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">返回产品系列</a></aside><div class="lux-reader-copy"><section class="lux-reader-section"><h2>产品信息</h2><dl class="lux-seo-facts"><div><dt>产品类型</dt><dd>食用菌罐头</dd></div><div><dt>配料</dt><dd>夏季黑松露（夏块菌）、水、食用盐；松露原产于欧盟。</dd></div><div><dt>致敏提醒</dt><dd>除对配料过敏或不耐受者外，所有人群均可食用。</dd></div><div><dt>原产国</dt><dd>意大利</dd></div><div><dt>进口商</dt><dd>露意膳（上海）贸易有限公司</dd></div><div><dt>进口商地址</dt><dd>上海市金山区枫泾镇曹黎路38弄19号5312室</dd></div><div><dt>贮存条件</dt><dd>置于阴凉干燥处；开封后需2°C-4°C冷藏保存。</dd></div><div><dt>境外生产企业注册编号</dt><dd>CITA19012411040130</dd></div><div><dt>营养成分</dt><dd>每100克：能量223千焦，蛋白质5.8克，脂肪0.6克，碳水化合物2.6克，糖0克，膳食纤维7.2克，钠490毫克。</dd></div></dl></section></div></section></article></main>
<!-- lux:footer:start -->
