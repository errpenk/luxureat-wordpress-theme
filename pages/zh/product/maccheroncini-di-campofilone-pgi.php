...
<!-- lux:seo:start -->
<title>坎波菲洛内通心粉（原产地认证） · 250 g | LuxurEat</title>
<meta name="description" content="源自坎波菲洛内的经典鸡蛋面，以意大利硬质小麦粗面粉与新鲜鸡蛋制成。面体极细，经过低温缓慢干燥后呈现粗糙多孔的质地，既能充分吸附酱汁，又保持细腻轻盈的口感。2013 年获得欧盟地理标志保护（PGI）认证，并严格限定于坎波菲洛内当地生产。">
<!-- lux:seo:end -->
<!-- lux:fonts:start -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('product/maccheroncini-di-campofilone-pgi')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/product/maccheroncini-di-campofilone-pgi')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">系列产品</a><span aria-hidden="true">/</span><span aria-current="page">坎波菲洛内通心粉（原产地认证） · 250 g</span></nav><article class="lux-reader-layout lux-product-seo-page"><div class="lux-reader-rule"></div><section class="lux-reader-hero"><div class="lux-reader-hero-copy"><div class="lux-reader-meta-grid"><span>面食</span><span>250 g / 4 人份</span><span>Marcozzi di Campofilone</span></div><h1 id="lux-reader-title">坎波菲洛内通心粉（原产地认证） · 250 g</h1><p class="lux-reader-summary">源自坎波菲洛内的经典鸡蛋面，以意大利硬质小麦粗面粉与新鲜鸡蛋制成。面体极细，经过低温缓慢干燥后呈现粗糙多孔的质地，既能充分吸附酱汁，又保持细腻轻盈的口感。2013 年获得欧盟地理标志保护（PGI）认证，并严格限定于坎波菲洛内当地生产。</p></div><figure class="lux-reader-cover"><img width="722" height="228" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/products/pasta/maccheroncini-di-campofilone-pgi.webp'); ?>" alt="坎波菲洛内通心粉（原产地认证） · 250 g"></figure></section><section class="lux-reader-content"><aside class="lux-reader-aside"><a href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>">返回产品系列</a></aside><div class="lux-reader-copy"><section class="lux-reader-section"><h2>产品信息</h2><dl class="lux-seo-facts"><div><dt>产品类型</dt><dd>面食</dd></div><div><dt>产品编号</dt><dd>M0001</dd></div><div><dt>包装规格</dt><dd>250 g / 4 人份</dd></div><div><dt>建议烹饪时间</dt><dd>1–2 分钟</dd></div><div><dt>尺寸</dt><dd>0.6/0.7 mm × 1 mm；长 45–55 cm</dd></div><div><dt>主要配料</dt><dd>硬质小麦粗面粉、鸡蛋 35.3%</dd></div><div><dt>工艺</dt><dd>粗糙多孔、缓慢干燥</dd></div><div><dt>生产商</dt><dd>Marcozzi di Campofilone（魔蔻滋）</dd></div></dl></section></div></section></article></main>
<!-- lux:footer:start -->
