...
<img class="w-full h-full object-cover" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/lux-032.jpg'); ?>">
...
<img class="w-full h-full object-cover" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/products/lux-026.jpg'); ?>">
...
<article class="lux-journal-season-card article-card lux-reader-card group cursor-pointer transition-all duration-1000 opacity-100">
<div class="aspect-[4/5] overflow-hidden mb-6 border border-white/5 lux-reader-media">
<img class="w-full h-full object-cover" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/lux-003.jpg'); ?>">
...
<article class="lux-journal-season-card article-card lux-reader-card group cursor-pointer transition-all duration-1000 opacity-100">
<div class="aspect-[4/5] overflow-hidden mb-6 border border-white/5 lux-reader-media">
<img class="w-full h-full object-cover" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/lux-048.jpg'); ?>">
