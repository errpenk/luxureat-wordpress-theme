...
<!-- lux:fonts:start -->
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-caviar-critical.woff2?v=20260804-search-cta-147'); ?>" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-caviar-critical.woff2?v=20260804-search-cta-147'); ?>" as="font" type="font/woff2" crossorigin>
<style data-lux-critical-fonts>@font-face{font-family:"KingHwa Old Song Page";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-caviar-critical.woff2?v=20260804-search-cta-147'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:block}@font-face{font-family:"LuxurEat ZhiSong Page";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-caviar-critical.woff2?v=20260804-search-cta-147'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:block}</style>
<!-- lux:fonts:end -->
...
<section class="lux-product-topic-bridge" aria-labelledby="product-topic-bridge-title-zh">
<header><span>PRODUCT KNOWLEDGE / 产品知识</span><h2 id="product-topic-bridge-title-zh">先理解食材，<em>再选择产品。</em></h2><p>产品目录负责呈现可确认的规格；产区、风味、营养、过敏原与使用方式，统一在知识博客中持续补充。</p></header>
<div><a href="<?php echo esc_url(luxureat_static_url('zh/blog', '?topic=olive')); ?>"><strong>意大利特级初榨橄榄油</strong><span>产区、品种、品鉴、保存与食谱</span><b>进入橄榄油学院 ↗</b></a><a href="<?php echo esc_url(luxureat_static_url('zh/blog', '?topic=gelato')); ?>"><strong>意式 Gelato 与 Ugolini 方向</strong><span>文化、工艺、专业应用与上市前信息</span><b>查看 Gelato 专题 ↗</b></a></div>
</section>
