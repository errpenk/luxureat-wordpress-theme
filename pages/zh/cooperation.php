...
<!-- lux:seo:start -->
<title>商务合作 | LuxurEat（露意膳）</title>
<meta name="description" content="探索 LuxurEat（露意膳）的国际市场定制、品牌合作、渠道方案与中国市场服务。">
<!-- lux:seo:end -->
<!-- lux:fonts:start -->
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-gifting-critical.woff2?v=20260812-mobile-fast-45'); ?>" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-gifting-critical.woff2?v=20260812-mobile-fast-45'); ?>" as="font" type="font/woff2" crossorigin>
<style data-lux-critical-fonts>@font-face{font-family:"KingHwa Page Critical";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-gifting-critical.woff2?v=20260812-mobile-fast-45'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:swap}@font-face{font-family:"KingHwa Old Song Site";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-site.woff2?v=20260812-mobile-fast-45'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:swap}@font-face{font-family:"ZhiSong Page Critical";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-gifting-critical.woff2?v=20260812-mobile-fast-45'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:swap}@font-face{font-family:"LuxurEat ZhiSong Site";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-site.woff2?v=20260812-mobile-fast-45'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:swap}html[lang^="zh"]{--lux-page-heading:"KingHwa Page Critical","Songti SC",serif!important;--lux-zh-headline:"KingHwa Page Critical","Songti SC",serif!important;--lux-zh-body:"ZhiSong Page Critical","Songti SC",serif!important}html.lux-full-fonts[lang^="zh"]{--lux-page-heading:"KingHwa Page Critical","KingHwa Old Song Site","Songti SC",serif!important;--lux-zh-headline:"KingHwa Page Critical","KingHwa Old Song Site","Songti SC",serif!important;--lux-zh-body:"ZhiSong Page Critical","LuxurEat ZhiSong Site","Songti SC",serif!important}</style>
<!-- lux:fonts:end -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="#">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/cooperation', '')); ?>">EN</a></span>
...
<div class="lux-page-hero-content relative z-10 text-center px-margin-mobile md:px-margin-desktop max-w-5xl mx-auto">
...
<a class="inline-flex items-center gap-3 text-secondary border-b border-secondary/40 pb-2 hover:text-primary hover:border-primary transition-colors" href="mailto:roberto@ugolinigroup.com?subject=LuxurEat（露意膳）%20%E5%95%86%E5%8A%A1%E5%90%88%E4%BD%9C%E5%92%A8%E8%AF%A2">讨论定制项目 <span aria-hidden="true">→︎</span></a>
</div>
...
<div class="group">
<div class="relative aspect-[4/5] overflow-hidden bg-surface-container-low mb-6">
<img width="640" height="960" loading="lazy" decoding="async" alt="LuxurEat 厨师团队的专业餐饮稳定供应方案" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cooperation-foodservice-chefs.jpg'); ?>"/>
</div>
...
<figure><figcaption>海外联系</figcaption><img width="512" height="507" class="lux-importer-qr" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/luxureat-contact-qr-transparent.webp'); ?>" alt="LuxurEat（露意膳） 海外联系二维码"></figure>
<figure><figcaption>国内联系</figcaption><img width="600" height="600" class="lux-importer-qr" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/luxureat-domestic-contact-qr-transparent.webp'); ?>" alt="LuxurEat（露意膳） 国内联系微信二维码"></figure>
</div>
</article>
</div>
</div>
