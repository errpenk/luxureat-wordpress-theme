...
<!-- lux:seo:end -->
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-hero-truffle-poster-lite.webp'); ?>" as="image" type="image/webp" fetchpriority="high">
<!-- lux:fonts:start -->
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-hero-critical.woff2?v=20260812-scroll-footer-group-65-home-font4'); ?>" as="font" type="font/woff2" crossorigin>
<style data-lux-critical-fonts>@font-face{font-family:"KingHwa Page Critical";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-home-critical.woff2?v=20260812-scroll-footer-group-65-home-font4'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:swap}@font-face{font-family:"KingHwa Old Song Site";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-site.woff2?v=20260812-scroll-footer-group-65'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:swap}@font-face{font-family:"ZhiSong Hero Critical";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-hero-critical.woff2?v=20260812-scroll-footer-group-65-home-font4'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:swap}@font-face{font-family:"ZhiSong Page Critical";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-home-subset.woff2?v=20260812-scroll-footer-group-65'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:swap}@font-face{font-family:"LuxurEat ZhiSong Site";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-site.woff2?v=20260812-scroll-footer-group-65'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:swap}html[lang^="zh"]{--lux-page-heading:"KingHwa Page Critical","KingHwa Old Song Site"!important;--lux-zh-headline:"KingHwa Page Critical","KingHwa Old Song Site"!important;--lux-zh-body:"ZhiSong Page Critical","LuxurEat ZhiSong Site"!important}html[lang^="zh"] body :is(.lux-header,.lux-home-hero,.lux-cookie-banner) :is(p,a,span,button){font-family:"ZhiSong Hero Critical","ZhiSong Page Critical","LuxurEat ZhiSong Site"!important}</style>
<!-- lux:fonts:end -->
...
<video data-lux-autoplay class="lux-hero-video" muted loop playsinline webkit-playsinline preload="none" disablepictureinpicture disableremoteplayback poster="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-hero-truffle-poster-lite.webp'); ?>" aria-hidden="true" tabindex="-1"><source media="(max-width: 640px)" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-hero-truffle-mobile.m4v'); ?>" type="video/mp4"><source src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-hero-truffle.mp4'); ?>" type="video/mp4"></video>
...
<a class="lux-home-service-card" href="<?php echo esc_url(luxureat_static_url('zh/product', '')); ?>"><figure><img width="640" height="457" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-service-selection-mobile.webp'); ?>" loading="lazy" decoding="async" data-lux-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-service-selection-640.webp'); ?>" alt="Ugolini 黑松露酱与专业餐饮应用"></figure><div><span class="material-symbols-outlined" data-icon="restaurant" aria-hidden="true" translate="no"></span><h3>产品甄选</h3><p>围绕渠道定位与消费场景配置松露、鱼子酱及高端食材。</p><b>探索产品 <i aria-hidden="true" translate="no"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14m-6-6 6 6-6 6"/></svg></i></b></div></a>
<a class="lux-home-service-card" href="<?php echo esc_url(luxureat_static_url('zh/cooperation', '')); ?>"><figure><img width="640" height="427" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-service-partnership-mobile.webp'); ?>" loading="lazy" decoding="async" data-lux-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-service-partnership-640.webp'); ?>" alt="LuxurEat（露意膳） 团队市场合作"></figure><div><span class="material-symbols-outlined" data-icon="hub" aria-hidden="true" translate="no"></span><h3>市场合作</h3><p>从市场准入、中文资料到渠道启动，提供一站式协作。</p><b>合作方案 <i aria-hidden="true" translate="no"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14m-6-6 6 6-6 6"/></svg></i></b></div></a>
<a class="lux-home-service-card" href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>"><figure><img width="640" height="638" data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-service-foodservice-mobile.webp'); ?>" loading="lazy" decoding="async" data-lux-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-service-foodservice-640.webp'); ?>" alt="TruffleEat 松露烩饭与餐饮应用"></figure><div><span class="material-symbols-outlined" data-icon="room_service" aria-hidden="true" translate="no"></span><h3>餐饮应用</h3><p>让专业食材自然进入菜单、宴会与高端零售体验。</p><b>查看灵感 <i aria-hidden="true" translate="no"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14m-6-6 6 6-6 6"/></svg></i></b></div></a>
</div>
</div>
</section>
