...
<!-- lux:fonts:start -->
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-home-critical.woff2?v=20260801-mobile-optimal-128'); ?>" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-home-subset.woff2?v=20260801-mobile-optimal-128'); ?>" as="font" type="font/woff2" crossorigin>
<style data-lux-critical-fonts>@font-face{font-family:"KingHwa Old Song Home";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-home-critical.woff2?v=20260801-mobile-optimal-128'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:block}@font-face{font-family:"LuxurEat ZhiSong Home";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-home-subset.woff2?v=20260801-mobile-optimal-128'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:block}</style>
<!-- lux:fonts:end -->
<link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri() . '/assets/css/tailwind-home.css?v=20260801-mobile-optimal-128'); ?>">
<style>
    .fade-in-up {
...
<article data-timeline-step data-timeline-index="3"><span>2026及未来</span><h3>共同塑造未来</h3><p>面向未来，LuxurEat（露意膳） 将继续以松露、鱼子酱与高端意大利食品为核心，拓展更丰富的产品、餐饮与品牌合作方案。我们期待与生产者、经销商、酒店餐饮及零售伙伴共同创造经得起时间检验的增长机会。</p><img class="lux-timeline-step-orbit" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-timeline-vision.webp'); ?>" alt="CaviarEat 鱼子酱与未来美食体验"></article>
</div>
<figure class="lux-home-timeline-visual" aria-label="LuxurEat（露意膳） 品牌历程图集">
<img data-timeline-image class="is-active" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-china-partnership-roberto.jpg'); ?>" alt="Roberto Ugolini 与 TrufflEat 品牌">
<img data-timeline-image loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-timeline-experience.jpg'); ?>" alt="Roberto Ugolini 与餐饮行业伙伴">
<img data-timeline-image loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-timeline-cooperation.webp'); ?>" alt="LuxurEat（露意膳） 在中国连接国际品牌与本地市场">
<img data-timeline-image loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-timeline-vision.webp'); ?>" alt="CaviarEat 鱼子酱与未来美食体验">
</figure>
</div>
</section>
<section class="lux-home-why" id="china-partnership" aria-labelledby="lux-home-why-title">
<div class="lux-home-why-media">
<figure class="lux-home-why-main"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-china-partnership-caviar.webp'); ?>" alt="冰上陈列的 CaviarEat 奥西特拉鱼子酱"></figure>
<figure class="lux-home-why-inset"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-china-partnership-truffles.jpg'); ?>" alt="精选意大利黑松露"></figure>
</div>
