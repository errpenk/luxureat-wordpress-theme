...
<!-- lux:fonts:start -->
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-home-critical.woff2?v=20260804-kinghwa-fallback-150'); ?>" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-home-subset.woff2?v=20260804-kinghwa-fallback-150'); ?>" as="font" type="font/woff2" crossorigin>
<style data-lux-critical-fonts>@font-face{font-family:"KingHwa Old Song Home";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-home-critical.woff2?v=20260804-kinghwa-fallback-150'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:block}@font-face{font-family:"LuxurEat ZhiSong Home";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-home-subset.woff2?v=20260804-kinghwa-fallback-150'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:block}@font-face{font-family:"KingHwa Old Song Complete";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-complete.ttf?v=20260804-kinghwa-fallback-150'); ?>") format("truetype");font-weight:700;font-style:normal;font-display:block}</style>
<!-- lux:fonts:end -->
<link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri() . '/assets/css/tailwind-home.css?v=20260804-kinghwa-fallback-150'); ?>">
<style>
    .fade-in-up {
...
<header><span>ITALIAN FOOD CULTURE / 意大利美食文化</span><h2 id="topic-preview-title-zh">从真实风味，<br><em>认识意大利。</em></h2><p>从二十个大区、地方传统到橄榄油、Gelato、食谱和营养信息，建立一条从知识、信任到餐桌应用的内容路径。</p></header>
<div class="lux-home-topic-grid">
<a class="lux-topic-preview-card" href="<?php echo esc_url(luxureat_static_url('zh/blog', '?topic=culture')); ?>"><figure><img data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-partnership-italy-pavilion-mobile.webp'); ?>" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/home-partnership-italy-pavilion.webp'); ?>" alt="意大利展馆与品牌交流现场"></figure><div><span>01 / TERRITORIO</span><h3>探索意大利</h3><p>二十个大区、地方传统、特色食材、产地到餐桌与餐桌礼仪。</p><b>查看文化地图 <i aria-hidden="true" translate="no"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 17 17 7M7 7h10v10"/></svg></i></b></div></a>
<a class="lux-topic-preview-card" href="<?php echo esc_url(luxureat_static_url('zh/blog', '?topic=academy')); ?>"><figure><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/craftsmanship-truffle-chef.webp'); ?>" alt="厨师以意大利食材完成料理"></figure><div><span>02 / ACCADEMIA</span><h3>意大利美食学院</h3><p>食材认识、基础技法、意大利面、风味搭配与生产者故事。</p><b>进入美食学院 <i aria-hidden="true" translate="no"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 17 17 7M7 7h10v10"/></svg></i></b></div></a>
<a class="lux-topic-preview-card" href="<?php echo esc_url(luxureat_static_url('zh/blog', '?topic=olive')); ?>"><figure><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/gifting-collab-truffle-oil.jpg'); ?>" alt="意大利调味油与餐桌应用"></figure><div><span>03 / OLIO ITALIANO</span><h3>意大利橄榄油</h3><p>历史、产区、品种、营养、品鉴、保存、误区与日常使用。</p><b>进入橄榄油学院 <i aria-hidden="true" translate="no"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 17 17 7M7 7h10v10"/></svg></i></b></div></a>
<a class="lux-topic-preview-card" href="<?php echo esc_url(luxureat_static_url('zh/blog', '?topic=gelato')); ?>"><figure><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-truffle-tiramisu.webp'); ?>" alt="意大利甜品的精致呈现"></figure><div><span>04 / GELATO ITALIANO</span><h3>意式 Gelato</h3><p>区分 Gelato 与 Ice Cream，了解工艺、专业应用与 Ugolini 未来产品方向。</p><b>进入 Gelato 学院 <i aria-hidden="true" translate="no"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 17 17 7M7 7h10v10"/></svg></i></b></div></a>
<a class="lux-topic-preview-card" href="<?php echo esc_url(luxureat_static_url('zh/rituals', '#olive-recipes')); ?>"><figure><img loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-truffle-tagliolini.webp'); ?>" alt="意大利面料理"></figure><div><span>05 / RICETTE</span><h3>意大利食谱</h3><p>按食材、产区和场景阅读食谱，逐步补齐时间、热量、过敏原与替代信息。</p><b>查看橄榄油食谱 <i aria-hidden="true" translate="no"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 17 17 7M7 7h10v10"/></svg></i></b></div></a>
<a class="lux-topic-preview-card" href="<?php echo esc_url(luxureat_static_url('zh/blog', '?topic=nutrition')); ?>"><figure><img data-lux-mobile-src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-laboratory-control-mobile.webp'); ?>" loading="lazy" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/brand/cert-laboratory-control.webp'); ?>" alt="食品质量与配料检验"></figure><div><span>06 / NUTRIZIONE</span><h3>营养与配料指南</h3><p>读懂配料表、营养成分、过敏原、清洁标签与食品误区。</p><b>查看营养指南 <i aria-hidden="true" translate="no"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 17 17 7M7 7h10v10"/></svg></i></b></div></a>
</div>
</div>
</section>
