...
<!-- lux:seo:start -->
<title>西葫芦意式煎蛋 | LuxurEat</title>
<meta name="description" content="先炒去西葫芦多余水分，再与鸡蛋和帕玛森凝固成柔嫩烘蛋，是适合家庭平底锅完成的意大利日常菜。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/family-zucchini-frittata')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/family-zucchini-frittata')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">西葫芦意式煎蛋</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1800" height="1200" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-family-zucchini-frittata.webp'); ?>" alt="西葫芦意式煎蛋"></figure><div class="lux-recipe-intro"><span>适合中国家庭的意大利菜</span><h1 id="lux-reader-title">西葫芦意式煎蛋</h1><p>先炒去西葫芦多余水分，再与鸡蛋和帕玛森凝固成柔嫩烘蛋，是适合家庭平底锅完成的意大利日常菜。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>35分钟</dd></div><div><dt>难度</dt><dd>简单</dd></div><div><dt>份量</dt><dd>4人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>鸡蛋6个（约300克）</li><li>西葫芦450克</li><li>洋葱80克</li><li>帕玛森奶酪30克，磨碎</li><li>特级初榨橄榄油20克</li><li>细盐2.5克</li><li>现磨黑胡椒适量</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>西葫芦洗净擦干，切成薄片；洋葱切细丝。</li><li>不粘平底锅加入一半橄榄油，中火炒洋葱至变软。</li><li>加入西葫芦和少量盐，中高火炒至水分明显减少，约6–8分钟。</li><li>鸡蛋打入大碗，加入帕玛森、剩余盐和黑胡椒，搅匀。</li><li>将炒好的西葫芦稍微放凉后加入蛋液。</li><li>擦净锅底，加入剩余橄榄油并以中低火加热。</li><li>倒入蛋液，轻轻晃平。</li><li>盖锅，以小火煮8–10分钟，直至边缘凝固、中心仍略湿。</li><li>借助大盘翻面，或放入预热烤箱上火完成表面。</li><li>继续加热3–5分钟，中心温度达到71°C。</li><li>静置5分钟后切块上桌。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>约990千焦 / 235千卡</dd></div><div><dt>脂肪</dt><dd>约17克</dd></div><div><dt>其中饱和脂肪</dt><dd>约5.5克</dd></div><div><dt>碳水化合物</dt><dd>约6克</dd></div><div><dt>其中糖</dt><dd>约4克</dd></div><div><dt>蛋白质</dt><dd>约16克</dd></div><div><dt>膳食纤维</dt><dd>约1.5克</dd></div><div><dt>钠</dt><dd>约500毫克</dd></div></dl><p class="lux-recipe-nutrition-note"><strong>营养说明</strong>营养数据为每份估算值。</p></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>意大利家庭料理</dd></div><div><dt>推荐用油</dt><dd>果香温和的特级初榨橄榄油。</dd></div><div><dt>专业提示</dt><dd>西葫芦必须先炒去多余水分，否则烘蛋会松散并渗水。</dd></div><div><dt>食品安全</dt><dd>带壳鸡蛋应完全加热；中心温度达到71°C。高风险人群应使用巴氏杀菌蛋制品。</dd></div><div><dt>过敏原提示</dt><dd>含蛋、牛奶（帕玛森）。</dd></div><div><dt>可替换食材</dt><dd>帕玛森可换为 格拉娜帕达诺奶酪；无乳糖奶酪并不等于不含牛奶蛋白。</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=olive-oil#product-catalogue')); ?>">LuxurEat（露意膳）特级初榨橄榄油产品</a></dd></div></section></article></main>
<!-- lux:footer:start -->
