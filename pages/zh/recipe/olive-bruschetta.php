...
<!-- lux:seo:start -->
<title>番茄罗勒意式烤面包 | LuxurEat</title>
<meta name="description" content="成熟番茄、烤面包、蒜与特级初榨橄榄油构成最经典的意式前菜之一。重点在于面包的酥脆、番茄的新鲜度，以及最后加入的橄榄油果香。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/olive-bruschetta')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/olive-bruschetta')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">番茄罗勒意式烤面包</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1800" height="1200" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-olive-bruschetta.webp'); ?>" alt="番茄罗勒意式烤面包"></figure><div class="lux-recipe-intro"><span>橄榄油食谱</span><h1 id="lux-reader-title">番茄罗勒意式烤面包</h1><p>成熟番茄、烤面包、蒜与特级初榨橄榄油构成最经典的意式前菜之一。重点在于面包的酥脆、番茄的新鲜度，以及最后加入的橄榄油果香。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>15分钟</dd></div><div><dt>难度</dt><dd>简单</dd></div><div><dt>份量</dt><dd>4人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>乡村面包160克，切4片</li><li>成熟番茄400克</li><li>特级初榨橄榄油30克（约33毫升）</li><li>蒜1瓣（约5克）</li><li>新鲜罗勒8克</li><li>细盐2克</li><li>现磨黑胡椒适量</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>番茄洗净、擦干并切成约1厘米小丁。加入20克橄榄油、盐和撕碎的罗勒，轻轻拌匀后静置10分钟。</li><li>面包在烤箱、烤架或干燥平底锅中烤至两面金黄且表面酥脆。</li><li>趁热用切开的蒜瓣轻擦面包表面，不要反复摩擦，以免蒜味压过番茄和橄榄油。</li><li>将番茄沥去过多汁液后铺在面包上，淋剩余10克橄榄油，磨少量黑胡椒，立即上桌。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>约850千焦 / 205千卡</dd></div><div><dt>脂肪</dt><dd>约9克</dd></div><div><dt>其中饱和脂肪</dt><dd>约1.5克</dd></div><div><dt>碳水化合物</dt><dd>约24克</dd></div><div><dt>其中糖</dt><dd>约4克</dd></div><div><dt>蛋白质</dt><dd>约5克</dd></div><div><dt>膳食纤维</dt><dd>约2.5克</dd></div><div><dt>钠</dt><dd>约390毫克</dd></div></dl><p class="lux-recipe-nutrition-note"><strong>营养说明</strong>营养数据为按上述标准化配料计算的每份估算值，实际结果会因面包品牌、番茄品种及实际调味量而变化。</p></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>意大利中部广泛流行；经典意式前菜</dd></div><div><dt>推荐用油</dt><dd>中等果香、低至中等苦辣度的特级初榨橄榄油。</dd></div><div><dt>专业提示</dt><dd>面包应保持酥脆，番茄汁不要过多；橄榄油在最后加入，才能保留清晰果香。</dd></div><div><dt>食品安全</dt><dd>生食番茄和罗勒应在流动饮用水下充分清洗并擦干。装配后建议立即食用，避免长时间室温放置。</dd></div><div><dt>过敏原提示</dt><dd>含麸质谷物（面包）。</dd></div><div><dt>可替换食材</dt><dd>乡村面包可换为法棍或酸面包；有无麸质需求时，应使用经认证的无麸质面包。</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=olive-oil#product-catalogue')); ?>">LuxurEat（露意膳）特级初榨橄榄油产品（以实际目录和标签为准）</a></dd></div></section></article></main>
<!-- lux:footer:start -->
