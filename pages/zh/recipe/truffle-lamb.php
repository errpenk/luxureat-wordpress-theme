...
<!-- lux:seo:start -->
<title>翁布里亚黑松露烩羊肉 | LuxurEat</title>
<meta name="description" content="翁布里亚 瓦尔内里纳 风格慢炖羊肉，以白葡萄酒、迷迭香和黑松露完成；松露在最后加入，避免香气流失。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/truffle-lamb')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/truffle-lamb')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">翁布里亚黑松露烩羊肉</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1125" height="750" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-truffle-lamb.webp'); ?>" alt="翁布里亚黑松露烩羊肉"></figure><div class="lux-recipe-intro"><span>松露食谱</span><h1 id="lux-reader-title">翁布里亚黑松露烩羊肉</h1><p>翁布里亚 瓦尔内里纳 风格慢炖羊肉，以白葡萄酒、迷迭香和黑松露完成；松露在最后加入，避免香气流失。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>约1小时45分钟</dd></div><div><dt>难度</dt><dd>中等</dd></div><div><dt>份量</dt><dd>6人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>去骨羊肩或羊腿肉1.2千克，切约4厘米块</li><li>黑松露50克</li><li>特级初榨橄榄油35克</li><li>蒜2瓣（约10克）</li><li>迷迭香2克</li><li>干白葡萄酒180毫升</li><li>低盐或无盐高汤约250毫升，按需</li><li>细盐7克</li><li>现磨黑胡椒适量</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>羊肉擦干，以盐和黑胡椒调味。</li><li>厚底锅加入橄榄油，中高火分批将羊肉煎至表面金黄。</li><li>羊肉取出备用。</li><li>锅中加入拍裂的蒜和迷迭香，短暂炒香。</li><li>羊肉放回锅中，倒入白葡萄酒。</li><li>刮起锅底焦香物，煮至酒液约减半。</li><li>加入足量高汤，使液体达到羊肉约一半高度。</li><li>煮沸后转小火，半盖锅盖炖约60–75分钟。</li><li>期间翻动并按需补充少量高汤，直至羊肉柔嫩。</li><li>确认中心温度至少达到63°C并静置；慢炖通常会达到更高温度。</li><li>关火，加入30克细磨黑松露拌入酱汁。</li><li>装盘后刨上剩余20克松露，立即上桌。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>约2130千焦 / 510千卡</dd></div><div><dt>脂肪</dt><dd>约25克</dd></div><div><dt>其中饱和脂肪</dt><dd>约8克</dd></div><div><dt>碳水化合物</dt><dd>约2克</dd></div><div><dt>其中糖</dt><dd>约1克</dd></div><div><dt>蛋白质</dt><dd>约57克</dd></div><div><dt>膳食纤维</dt><dd>少于1克</dd></div><div><dt>钠</dt><dd>约580毫克</dd></div></dl><p class="lux-recipe-nutrition-note"><strong>营养说明</strong>营养数据为每份估算值。</p></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>翁布里亚 瓦尔内里纳</dd></div><div><dt>推荐用油</dt><dd>结构感中等的特级初榨橄榄油。</dd></div><div><dt>专业提示</dt><dd>松露应在烹调结束时加入；长时间炖煮会显著削弱其香气。</dd></div><div><dt>食品安全</dt><dd>生羊肉应使用独立砧板并避免交叉污染。整块羊肉最低中心温度63°C并静置，慢炖菜通常加热至更高温度。</dd></div><div><dt>过敏原提示</dt><dd>基础配方不含欧盟14大主要过敏原；高汤可能含西芹或麸质，葡萄酒可能含亚硫酸盐。</dd></div><div><dt>可替换食材</dt><dd>可用羊肩或羊腿；葡萄酒可用高汤替代。</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=truffle#product-catalogue')); ?>">LuxurEat（露意膳）黑松露与特级初榨橄榄油产品</a></dd></div></section></article></main>
<!-- lux:footer:start -->
