...
<!-- lux:seo:start -->
<title>意式生蔬菜配橄榄油蘸汁 | LuxurEat</title>
<meta name="description" content="意式生蔬菜配橄榄油蘸汁 以新鲜、脆爽的时令蔬菜搭配特级初榨橄榄油、盐、黑胡椒和少量柠檬汁，直接展现优质橄榄油的果香、苦味和辛香感。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/olive-pinzimonio')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/olive-pinzimonio')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">意式生蔬菜配橄榄油蘸汁</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1600" height="1067" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-olive-pinzimonio.webp'); ?>" alt="意式生蔬菜配橄榄油蘸汁"></figure><div class="lux-recipe-intro"><span>橄榄油食谱</span><h1 id="lux-reader-title">意式生蔬菜配橄榄油蘸汁</h1><p>意式生蔬菜配橄榄油蘸汁 以新鲜、脆爽的时令蔬菜搭配特级初榨橄榄油、盐、黑胡椒和少量柠檬汁，直接展现优质橄榄油的果香、苦味和辛香感。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>20分钟</dd></div><div><dt>难度</dt><dd>简单</dd></div><div><dt>份量</dt><dd>4人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>胡萝卜160克</li><li>西芹120克</li><li>茴香球200克</li><li>红甜椒150克</li><li>小萝卜100克</li><li>菊苣或红菊苣120克</li><li>特级初榨橄榄油60克（约66毫升）</li><li>新鲜柠檬汁20克</li><li>细盐2克</li><li>现磨黑胡椒适量</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>所有蔬菜在流动饮用水下充分洗净并彻底擦干。</li><li>胡萝卜、西芹、茴香和甜椒切成长条，小萝卜对半切，菊苣分成适合手持的叶片。</li><li>将橄榄油、柠檬汁、盐和黑胡椒放入小碗，用叉子快速搅拌形成暂时乳化的蘸汁。</li><li>将蔬菜分类摆放在冷盘中，蘸汁按人数分装成小碗，现蘸现食。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>约790千焦 / 190千卡</dd></div><div><dt>脂肪</dt><dd>约15克</dd></div><div><dt>其中饱和脂肪</dt><dd>约2克</dd></div><div><dt>碳水化合物</dt><dd>约13克</dd></div><div><dt>其中糖</dt><dd>约7克</dd></div><div><dt>蛋白质</dt><dd>约3克</dd></div><div><dt>膳食纤维</dt><dd>约5克</dd></div><div><dt>钠</dt><dd>约300毫克</dd></div></dl><p class="lux-recipe-nutrition-note"><strong>营养说明</strong>营养数据为每份估算值，实际结果会随蔬菜种类、橄榄油实际食用量和调味量变化。</p></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>意大利多个地区均有传统</dd></div><div><dt>推荐用油</dt><dd>适合直接品尝的高品质特级初榨橄榄油。</dd></div><div><dt>专业提示</dt><dd>蔬菜必须新鲜、脆爽，橄榄油也不应有明显氧化、哈喇或陈旧气味。</dd></div><div><dt>食品安全</dt><dd>生食蔬菜要避免与处理生肉、生鱼的砧板和刀具交叉污染。切配后冷藏保存，建议2小时内上桌。</dd></div><div><dt>过敏原提示</dt><dd>标准配方不含欧盟14大主要过敏原；仍需根据实际加工原料和消费者个体情况确认。</dd></div><div><dt>可替换食材</dt><dd>可随季节加入黄瓜、樱桃番茄或甜菊苣，但应保持适合生食、脆爽和方便手持。</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=olive-oil#product-catalogue')); ?>">LuxurEat（露意膳）特级初榨橄榄油产品</a></dd></div></section></article></main>
<!-- lux:footer:start -->
