...
<!-- lux:seo:start -->
<title>西西里茴香橙子黑橄榄沙拉 | LuxurEat</title>
<meta name="description" content="清脆茴香、鲜甜橙子与黑橄榄组成西西里风格沙拉，以橙汁和特级初榨橄榄油完成清爽调味。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/light-fennel-orange-salad')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/light-fennel-orange-salad')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">西西里茴香橙子黑橄榄沙拉</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="720" height="494" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-light-fennel-orange-salad.webp'); ?>" alt="西西里茴香橙子黑橄榄沙拉"></figure><div class="lux-recipe-intro"><span>健康轻食</span><h1 id="lux-reader-title">西西里茴香橙子黑橄榄沙拉</h1><p>清脆茴香、鲜甜橙子与黑橄榄组成西西里风格沙拉，以橙汁和特级初榨橄榄油完成清爽调味。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>20分钟</dd></div><div><dt>难度</dt><dd>简单</dd></div><div><dt>份量</dt><dd>4人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>茴香球500克</li><li>橙子400克（约3个，以去皮后重量计）</li><li>去核黑橄榄80克</li><li>特级初榨橄榄油25克（约28毫升）</li><li>新鲜橙汁20克</li><li>细盐1.5克</li><li>现磨黑胡椒适量</li><li>茴香叶少量，装饰用</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>茴香洗净并彻底擦干，保留少量茴香叶；球茎纵向切半后切成均匀薄片。</li><li>橙子去皮并彻底去除白色筋膜，在碗上方切出果肉瓣并保留流出的果汁。</li><li>黑橄榄对半切开。</li><li>将20克橙汁、橄榄油、盐和黑胡椒搅拌成调味汁。</li><li>茴香、橙子和橄榄轻轻混合，淋入调味汁再次拌匀。</li><li>以茴香叶装饰并尽快上桌。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>约640千焦 / 155千卡</dd></div><div><dt>脂肪</dt><dd>约9克</dd></div><div><dt>其中饱和脂肪</dt><dd>约1.5克</dd></div><div><dt>碳水化合物</dt><dd>约18克</dd></div><div><dt>其中糖</dt><dd>约12克</dd></div><div><dt>蛋白质</dt><dd>约3克</dd></div><div><dt>膳食纤维</dt><dd>约6克</dd></div><div><dt>钠</dt><dd>约260毫克</dd></div></dl><p class="lux-recipe-nutrition-note"><strong>营养说明</strong>营养数据为每份估算值，实际结果会随橙子、橄榄及调味量变化。</p></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>西西里</dd></div><div><dt>推荐用油</dt><dd>果香清晰、苦辣度温和的特级初榨橄榄油。</dd></div><div><dt>专业提示</dt><dd>茴香要切得均匀而薄；橙子应多汁、酸甜平衡，才能让沙拉保持清爽。</dd></div><div><dt>食品安全</dt><dd>所有生食材料应充分清洗。若提前准备，请将各部分分开冷藏，食用前再混合。</dd></div><div><dt>过敏原提示</dt><dd>标准配方不含欧盟14大主要过敏原；加工橄榄仍需核对标签。</dd></div><div><dt>可替换食材</dt><dd>可使用其他风味温和的去核黑橄榄；不要使用糖浆罐头橙子。</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=olive-oil#product-catalogue')); ?>">LuxurEat（露意膳）特级初榨橄榄油产品</a></dd></div></section></article></main>
<!-- lux:footer:start -->
