...
<!-- lux:seo:start -->
<title>托斯卡纳面包沙拉 | LuxurEat</title>
<meta name="description" content="托斯卡纳面包沙拉 是托斯卡纳及意大利中部经典的陈面包沙拉。略微回软的面包吸收番茄、醋和特级初榨橄榄油的风味，形成清爽又保留结构感的夏季料理。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/olive-panzanella')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/olive-panzanella')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">托斯卡纳面包沙拉</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="500" height="334" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-olive-panzanella.webp'); ?>" alt="托斯卡纳面包沙拉"></figure><div class="lux-recipe-intro"><span>橄榄油食谱</span><h1 id="lux-reader-title">托斯卡纳面包沙拉</h1><p>托斯卡纳面包沙拉 是托斯卡纳及意大利中部经典的陈面包沙拉。略微回软的面包吸收番茄、醋和特级初榨橄榄油的风味，形成清爽又保留结构感的夏季料理。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>约55分钟，含静置时间</dd></div><div><dt>难度</dt><dd>简单</dd></div><div><dt>份量</dt><dd>4人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>陈乡村面包240克</li><li>成熟番茄500克</li><li>黄瓜180克</li><li>红洋葱80克</li><li>新鲜罗勒12克</li><li>特级初榨橄榄油40克（约44毫升）</li><li>红酒醋20克</li><li>冷饮用水约120毫升</li><li>细盐3克</li><li>现磨黑胡椒适量</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>面包切成约1厘米厚片或较大的块，均匀洒上冷水和约一半红酒醋。</li><li>静置10–15分钟，使面包回软，但不要完全泡烂。</li><li>番茄切块，黄瓜切片，红洋葱切薄片；洋葱过辣时可在冷水中浸泡10分钟后彻底沥干。</li><li>轻轻挤去面包中过多水分，再用手撕成大小均匀的块。</li><li>将面包、番茄、黄瓜、洋葱和罗勒混合。</li><li>加入剩余红酒醋、橄榄油、盐和黑胡椒，轻轻拌匀。</li><li>冷藏静置约30分钟。上桌前再次拌匀，并微调酸度和盐度。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>约1160千焦 / 280千卡</dd></div><div><dt>脂肪</dt><dd>约12克</dd></div><div><dt>其中饱和脂肪</dt><dd>约2克</dd></div><div><dt>碳水化合物</dt><dd>约37克</dd></div><div><dt>其中糖</dt><dd>约7克</dd></div><div><dt>蛋白质</dt><dd>约7克</dd></div><div><dt>膳食纤维</dt><dd>约4克</dd></div><div><dt>钠</dt><dd>约530毫克</dd></div></dl><p class="lux-recipe-nutrition-note"><strong>营养说明</strong>营养数据为每份估算值，实际结果会随面包种类、面包含盐量及实际调味量变化。</p></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>托斯卡纳</dd></div><div><dt>推荐用油</dt><dd>果香清晰、苦辣度适中的托斯卡纳风格特级初榨橄榄油。</dd></div><div><dt>专业提示</dt><dd>面包应该湿润而有结构，而不是彻底泡成糊状。番茄汁、醋和橄榄油会继续软化面包，初始湿润程度不要过高。</dd></div><div><dt>食品安全</dt><dd>所有生食蔬菜和香草都应在流动饮用水下充分清洗。成品应冷藏保存并尽量当天食用。</dd></div><div><dt>过敏原提示</dt><dd>含麸质谷物（面包）。</dd></div><div><dt>可替换食材</dt><dd>传统托斯卡纳无盐面包可用结构紧实的陈乡村面包替代；红酒醋可换为白酒醋。</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=olive-oil#product-catalogue')); ?>">结构感清晰的 LuxurEat（露意膳）特级初榨橄榄油</a></dd></div></section></article></main>
<!-- lux:footer:start -->
