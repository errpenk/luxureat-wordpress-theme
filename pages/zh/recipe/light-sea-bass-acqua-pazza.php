...
<!-- lux:seo:start -->
<title>意式番茄水煮海鲈鱼 | LuxurEat</title>
<meta name="description" content="海鲈鱼在番茄、蒜、白葡萄酒和少量水构成的浅汤中轻柔煮熟，是坎帕尼亚经典的清淡鱼料理。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/light-sea-bass-acqua-pazza')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/light-sea-bass-acqua-pazza')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">意式番茄水煮海鲈鱼</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="800" height="600" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-light-sea-bass-acqua-pazza.webp'); ?>" alt="意式番茄水煮海鲈鱼"></figure><div class="lux-recipe-intro"><span>健康轻食</span><h1 id="lux-reader-title">意式番茄水煮海鲈鱼</h1><p>海鲈鱼在番茄、蒜、白葡萄酒和少量水构成的浅汤中轻柔煮熟，是坎帕尼亚经典的清淡鱼料理。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>30分钟</dd></div><div><dt>难度</dt><dd>中等</dd></div><div><dt>份量</dt><dd>4人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>去骨海鲈鱼排600克</li><li>樱桃番茄350克，对半切</li><li>水180毫升</li><li>干白葡萄酒80毫升，可选</li><li>特级初榨橄榄油25克</li><li>蒜2瓣（约10克）</li><li>新鲜欧芹15克</li><li>细盐3克</li><li>现磨黑胡椒适量</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>鱼排擦干，确认无残留鱼刺，以盐和黑胡椒轻调味。</li><li>宽锅加入橄榄油和拍裂的蒜，以中低火加热至出香。</li><li>加入番茄，中火翻炒约3分钟。</li><li>倒入白葡萄酒并煮1分钟使酒精挥发；不用酒时直接加等量水。</li><li>加入180毫升水，煮至轻微沸腾。</li><li>鱼排皮面朝下放入浅汤，盖锅以小火煮约6–8分钟。</li><li>根据厚度轻轻翻面，继续煮2–4分钟，中心温度达到63°C。</li><li>取出鱼排，汤汁按需稍微收浓。</li><li>加入欧芹，调整盐和黑胡椒。</li><li>将番茄和浅汤浇在鱼排周围，立即上桌。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>约1045千焦 / 250千卡</dd></div><div><dt>脂肪</dt><dd>约10克</dd></div><div><dt>其中饱和脂肪</dt><dd>约2克</dd></div><div><dt>碳水化合物</dt><dd>约5克</dd></div><div><dt>其中糖</dt><dd>约3克</dd></div><div><dt>蛋白质</dt><dd>约36克</dd></div><div><dt>膳食纤维</dt><dd>约1.5克</dd></div><div><dt>钠</dt><dd>约440毫克</dd></div></dl><p class="lux-recipe-nutrition-note"><strong>营养说明</strong>营养数据为每份估算值；葡萄酒是否使用会影响结果。</p></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>坎帕尼亚及意大利南部</dd></div><div><dt>推荐用油</dt><dd>中等果香、适合鱼类的特级初榨橄榄油。</dd></div><div><dt>专业提示</dt><dd>意式番茄水煮 是浅汤，不是大量水煮；液体只需帮助鱼肉温和熟成并形成鲜味汁液。</dd></div><div><dt>食品安全</dt><dd>生鱼应冷藏并与即食食材分开处理；中心温度达到63°C。剩余成品应在2小时内冷却冷藏。</dd></div><div><dt>过敏原提示</dt><dd>含鱼类；白葡萄酒可能含亚硫酸盐。</dd></div><div><dt>可替换食材</dt><dd>可用海鲷替代海鲈鱼；省略葡萄酒时增加80毫升水。</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=olive-oil#product-catalogue')); ?>">LuxurEat（露意膳）特级初榨橄榄油产品</a></dd></div></section></article></main>
<!-- lux:footer:start -->
