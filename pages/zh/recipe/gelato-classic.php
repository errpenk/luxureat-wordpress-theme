...
<!-- lux:seo:start -->
<title>经典意式手工冰淇淋 | LuxurEat</title>
<meta name="description" content="以均衡甜度、细腻质地与清晰风味呈现经典意式手工冰淇淋。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/gelato-classic')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/gelato-classic')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">经典意式手工冰淇淋</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1600" height="1063" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-gelato-classic.webp'); ?>" alt="经典意式手工冰淇淋"></figure><div class="lux-recipe-intro"><span>意式手工冰淇淋</span><h1 id="lux-reader-title">经典意式手工冰淇淋</h1><p>以均衡甜度、细腻质地与清晰风味呈现经典意式手工冰淇淋。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>准备35分钟＋冷藏4小时</dd></div><div><dt>难度</dt><dd>中等</dd></div><div><dt>份量</dt><dd>6人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>550克全脂牛奶</li><li>150克淡奶油</li><li>100克糖</li><li>30克脱脂奶粉</li><li>一小撮盐</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>混合糖与奶粉，缓慢加入牛奶和淡奶油并搅匀。</li><li>加热至82°C左右后离火，加入盐并充分乳化。</li><li>快速降温并冷藏至少4小时，让基底成熟。</li><li>倒入冰淇淋机搅冻，完成后短时冷冻定型；食用前稍微回温。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>约870千焦（约208千卡/份）</dd></div><div><dt>脂肪</dt><dd>约12克</dd></div><div><dt>碳水化合物</dt><dd>约20克</dd></div><div><dt>蛋白质</dt><dd>约6克</dd></div></dl></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>意大利</dd></div><div><dt>过敏原提示</dt><dd>含牛奶</dd></div><div><dt>可替换食材</dt><dd>可按配方结构选用适合的乳制品基底；无冰淇淋机时需分次冷冻搅拌</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=gelato#product-catalogue')); ?>">意式手工冰淇淋产品目录（以实际库存和标签为准）</a></dd></div></section></article></main>
<!-- lux:footer:start -->
