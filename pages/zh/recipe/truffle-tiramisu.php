...
<!-- lux:seo:start -->
<title>松露提拉米苏 | LuxurEat</title>
<meta name="description" content="松露提拉米苏是传统甜点的精致演绎，将经典提拉米苏的绵密奶香与松露的浓郁香气融合，呈现独特而优雅的风味。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/truffle-tiramisu')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/truffle-tiramisu')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">松露提拉米苏</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1000" height="667" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-truffle-tiramisu.webp'); ?>" alt="松露提拉米苏"></figure><div class="lux-recipe-intro"><span>甜点食谱</span><h1 id="lux-reader-title">松露提拉米苏</h1><p>松露提拉米苏是传统甜点的精致演绎，将经典提拉米苏的绵密奶香与松露的浓郁香气融合，呈现独特而优雅的风味。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>30分钟</dd></div><div><dt>难度</dt><dd>中等</dd></div><div><dt>份量</dt><dd>4人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>250克马斯卡彭奶酪</li><li>2个新鲜鸡蛋（蛋黄和蛋白分开）</li><li>60克糖</li><li>100克手指饼干</li><li>100毫升浓缩咖啡</li><li>1汤匙咖啡利口酒（可选）</li><li>5-6片薄薄的黑松露片</li><li>1茶匙松露油（可选，用于增强香气）</li><li>适量无糖可可粉</li><li>饼干或巧克力片，用于装饰</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>准备咖啡：将咖啡煮好后放凉。如果需要，可以加入利口酒。</li><li>制作马斯卡彭松露奶油：将蛋黄和糖打发至颜色变浅，加入马斯卡彭奶酪并轻轻搅拌。另将蛋白打发至硬性发泡，从底部向上拌入蛋黄混合物，最后淋上少许松露油。</li><li>将浸泡过咖啡的手指饼干和马斯卡彭奶油交替铺在模具或糕点圈中，并在每层之间放入薄薄的松露片。</li><li>最后铺上一层奶油，撒上无糖可可粉，再用松露碎屑和酥脆饼干屑装饰。</li><li>放入冰箱冷藏至少2小时后再食用。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>1300千焦（约310千卡）</dd></div><div><dt>饱和脂肪</dt><dd>7克（35%）</dd></div><div><dt>碳水化合物（糖类）</dt><dd>20克</dd></div><div><dt>蛋白质</dt><dd>7克</dd></div></dl></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>参考：威尼托甜点的创意表达</dd></div><div><dt>推荐用油</dt><dd>此食谱以松露油为风味点缀，不建议过量</dd></div><div><dt>过敏原提示</dt><dd>含蛋、奶、麸质；咖啡利口酒可能含酒精</dd></div><div><dt>可替换食材</dt><dd>马斯卡彭可用奶油奶酪；手指饼可按包装替换为无麸质版本</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=truffle#product-catalogue')); ?>">松露产品目录（以实际库存和标签为准）</a></dd></div></section></article></main>
<!-- lux:footer:start -->
