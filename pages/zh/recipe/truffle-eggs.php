...
<!-- lux:seo:start -->
<title>松露鸡蛋 | LuxurEat</title>
<meta name="description" content="松露鸡蛋是一道美味佳肴，它将新鲜鸡蛋的清爽与松露浓郁的香气完美融合。无论是早餐、早午餐，还是作为精致的开胃菜，这道菜都堪称完美之选。做法简单快捷，其香气和精致口感定会让您爱不释手。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/truffle-eggs')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/truffle-eggs')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">松露鸡蛋</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1000" height="667" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-truffle-eggs.webp'); ?>" alt="松露鸡蛋"></figure><div class="lux-recipe-intro"><span>早餐食谱</span><h1 id="lux-reader-title">松露鸡蛋</h1><p>松露鸡蛋是一道美味佳肴，它将新鲜鸡蛋的清爽与松露浓郁的香气完美融合。无论是早餐、早午餐，还是作为精致的开胃菜，这道菜都堪称完美之选。做法简单快捷，其香气和精致口感定会让您爱不释手。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>10分钟</dd></div><div><dt>难度</dt><dd>简单</dd></div><div><dt>份量</dt><dd>1人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>2个新鲜鸡蛋</li><li>1茶匙特级初榨橄榄油或一小块黄油</li><li>4-5片薄薄的黑松露片</li><li>几片新鲜欧芹叶（可选）</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>在不粘锅中倒入少许油或一小块黄油，加热。</li><li>轻轻敲开鸡蛋，用中小火煮，使蛋黄保持柔软。</li><li>加少许盐和胡椒粉。</li><li>鸡蛋快熟时，将松露片放在鸡蛋上，让热气释放松露的香气。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>950千焦（约225千卡）</dd></div><div><dt>饱和脂肪</dt><dd>5克（25%）</dd></div><div><dt>碳水化合物（糖类）</dt><dd>1克</dd></div><div><dt>蛋白质</dt><dd>12克</dd></div></dl></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>参考：意大利家庭早餐</dd></div><div><dt>推荐用油</dt><dd>特级初榨橄榄油或黄油，按实际产品标签使用</dd></div><div><dt>过敏原提示</dt><dd>含蛋；如使用黄油需注意牛奶过敏原</dd></div><div><dt>可替换食材</dt><dd>鸡蛋可按个人饮食替换；松露片可用适量松露产品替代</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=truffle#product-catalogue')); ?>">松露产品目录（以实际库存和标签为准）</a></dd></div></section></article></main>
<!-- lux:footer:start -->
