...
<!-- lux:seo:start -->
<title>水煮蛋配松露烤面包片 | LuxurEat</title>
<meta name="description" content="烤面包片配水煮蛋和松露，是一道精致的餐桌小点，非常适合招待客人或打造优雅的周日早午餐。金黄酥脆的面包与绵密的鸡蛋和浓郁的松露香气完美融合，带来令人难以抗拒的美味和口感。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/truffle-toast')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/truffle-toast')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">水煮蛋配松露烤面包片</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1000" height="667" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-truffle-toast.webp'); ?>" alt="水煮蛋配松露烤面包片"></figure><div class="lux-recipe-intro"><span>早餐食谱</span><h1 id="lux-reader-title">水煮蛋配松露烤面包片</h1><p>烤面包片配水煮蛋和松露，是一道精致的餐桌小点，非常适合招待客人或打造优雅的周日早午餐。金黄酥脆的面包与绵密的鸡蛋和浓郁的松露香气完美融合，带来令人难以抗拒的美味和口感。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>15分钟</dd></div><div><dt>难度</dt><dd>中等</dd></div><div><dt>份量</dt><dd>2人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>4片乡村面包或法棍面包</li><li>2个新鲜鸡蛋</li><li>1汤匙白醋</li><li>2汤匙新鲜涂抹型奶酪（例如罗比奥拉奶酪或里科塔奶酪）</li><li>5-6片薄薄的黑松露片</li><li>1茶匙刺山柑（可选）</li><li>新鲜罗勒叶</li><li>适量特级初榨橄榄油</li><li>盐和胡椒粉适量</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>将面包片烤至酥脆，加热烤盘或不粘锅。</li><li>准备水煮蛋：将一锅水和一汤匙醋烧开。用勺子在水面上搅出一个漩涡，然后轻轻地将鸡蛋打入漩涡中心。煮2-3分钟，直到蛋白凝固但蛋黄仍然溏心。</li><li>组装烤面包片：在面包片上涂抹奶油奶酪，放上水煮蛋，最后放上几片松露。</li><li>装饰：淋上少许橄榄油，撒上刺山柑（可选）和几片新鲜罗勒叶。用少许盐和胡椒粉调味。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>1300千焦（约310千卡）</dd></div><div><dt>饱和脂肪</dt><dd>6克（30%）</dd></div><div><dt>碳水化合物（糖类）</dt><dd>3克</dd></div><div><dt>蛋白质</dt><dd>12克</dd></div></dl></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>参考：意大利早午餐</dd></div><div><dt>推荐用油</dt><dd>风味清新的特级初榨橄榄油</dd></div><div><dt>过敏原提示</dt><dd>含麸质、蛋、奶；刺山柑按实际包装确认</dd></div><div><dt>可替换食材</dt><dd>乡村面包可替换为法棍或无麸质面包；罗比奥拉可替换为里科塔</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=truffle#product-catalogue')); ?>">松露产品目录（以实际库存和标签为准）</a></dd></div></section></article></main>
<!-- lux:footer:start -->
