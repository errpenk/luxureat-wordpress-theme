...
<!-- lux:seo:start -->
<title>扇贝松露牛肉薄片 | LuxurEat</title>
<meta name="description" content="牛肉薄片配扇贝和松露，将生牛肉的浓郁、扇贝的鲜嫩与黑松露的馥郁香气完美融合，是一道优雅而赏心悦目的菜肴。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/beef-carpaccio-scallop-truffle')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/beef-carpaccio-scallop-truffle')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">扇贝松露牛肉薄片</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1000" height="750" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-beef-carpaccio-scallop-truffle.webp'); ?>" alt="扇贝松露牛肉薄片"></figure><div class="lux-recipe-intro"><span>第二道主食</span><h1 id="lux-reader-title">扇贝松露牛肉薄片</h1><p>牛肉薄片配扇贝和松露，将生牛肉的浓郁、扇贝的鲜嫩与黑松露的馥郁香气完美融合，是一道优雅而赏心悦目的菜肴。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>15分钟</dd></div><div><dt>难度</dt><dd>中等</dd></div><div><dt>份量</dt><dd>2人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>120克牛肉薄片（极薄片）</li><li>4个新鲜扇贝</li><li>4-5片黑松露</li><li>1汤匙特级初榨橄榄油</li><li>1茶匙柠檬汁</li><li>盐和胡椒粉适量</li><li>几片混合沙拉蔬菜叶（例如混合蔬菜或芝麻菜）</li><li>几滴绿色酱汁（可选）</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>准备扇贝：在不粘锅中倒入少许油，轻轻加热，将扇贝两面各煎1分钟，保持中心柔软。</li><li>将牛肉薄片均匀地铺在平盘上，形成一层。</li><li>将扇贝放在生牛肉片的中央。</li><li>淋上少许橄榄油和柠檬汁，撒上盐和胡椒粉。最后以黑松露碎屑和沙拉叶装饰，如有需要，再加几滴青莎莎酱或豌豆奶油点缀。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>850千焦（约200千卡）</dd></div><div><dt>饱和脂肪</dt><dd>2克（10%）</dd></div><div><dt>碳水化合物（糖类）</dt><dd>1克</dd></div><div><dt>蛋白质</dt><dd>22克</dd></div></dl></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>参考：皮埃蒙特现代前菜</dd></div><div><dt>推荐用油</dt><dd>清新、低苦味的特级初榨橄榄油</dd></div><div><dt>过敏原提示</dt><dd>含鱼类/贝类；可能含芥末或其他酱汁过敏原，按包装确认</dd></div><div><dt>可替换食材</dt><dd>扇贝可换熟虾；生牛肉应使用符合食品安全要求的原料，不建议高风险人群食用</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=truffle#product-catalogue')); ?>">松露产品目录（以实际库存和标签为准）</a></dd></div></section></article></main>
<!-- lux:footer:start -->
