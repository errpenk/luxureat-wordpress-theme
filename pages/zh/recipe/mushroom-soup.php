...
<!-- lux:seo:start -->
<title>奶油蘑菇浓汤 | LuxurEat</title>
<meta name="description" content="一道温暖舒适的开胃菜，非常适合秋日享用。这款奶油蘑菇汤口感顺滑，散发着浓郁的森林香气，搭配金黄酥脆的烤面包丁或淋上少许松露油，风味更佳。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/mushroom-soup')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/mushroom-soup')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">奶油蘑菇浓汤</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1000" height="667" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-mushroom-soup.webp'); ?>" alt="奶油蘑菇浓汤"></figure><div class="lux-recipe-intro"><span>第一道主食</span><h1 id="lux-reader-title">奶油蘑菇浓汤</h1><p>一道温暖舒适的开胃菜，非常适合秋日享用。这款奶油蘑菇汤口感顺滑，散发着浓郁的森林香气，搭配金黄酥脆的烤面包丁或淋上少许松露油，风味更佳。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>35分钟</dd></div><div><dt>难度</dt><dd>简单</dd></div><div><dt>份量</dt><dd>2人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>300克混合新鲜蘑菇（香菇、牛肝菌或小菇）</li><li>1个中等大小的土豆</li><li>半个洋葱</li><li>1瓣大蒜</li><li>2汤匙特级初榨橄榄油</li><li>400毫升热蔬菜汤</li><li>2汤匙鲜奶油（可选）</li><li>盐和胡椒粉适量</li><li>新鲜欧芹碎，用于装饰</li><li>烤面包丁，用于佐餐</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>准备食材。用湿布擦拭蘑菇，然后切片。土豆去皮，切成小丁。洋葱和大蒜切碎。</li><li>翻炒。在平底锅中加热橄榄油，将洋葱和大蒜翻炒2-3分钟。加入蘑菇和土豆，继续翻炒约5分钟，让各种食材的味道融合。</li><li>烹煮。倒入热蔬菜汤，盖上盖子，用中火慢炖约20分钟，直到蔬菜变软。</li><li>搅拌。离火，用手持搅拌机将所有食材搅拌至顺滑浓稠。如果想要更浓郁的口感，可以加入奶油并搅拌均匀。</li><li>调整口味后即可享用。用盐和胡椒调味，撒上切碎的欧芹装饰，趁热配上金黄酥脆的面包丁或淋上少许松露油。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>870千焦（约210千卡）</dd></div><div><dt>饱和脂肪</dt><dd>2克（10%）</dd></div><div><dt>碳水化合物（糖类）</dt><dd>14克（其中4克为西葫芦）</dd></div><div><dt>蛋白质</dt><dd>6克</dd></div></dl></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>参考：翁布里亚 / 中部意大利风味</dd></div><div><dt>推荐用油</dt><dd>果香温和的特级初榨橄榄油</dd></div><div><dt>过敏原提示</dt><dd>如加入奶油则含奶；高汤需按包装确认</dd></div><div><dt>可替换食材</dt><dd>奶油可省略或用无糖燕麦奶替代；香菇、口蘑可按供应替换</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=truffle#product-catalogue')); ?>">松露产品目录（以实际库存和标签为准）</a></dd></div></section></article></main>
<!-- lux:footer:start -->
