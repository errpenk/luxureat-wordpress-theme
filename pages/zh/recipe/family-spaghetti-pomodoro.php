...
<!-- lux:seo:start -->
<title>经典番茄意面 | LuxurEat</title>
<meta name="description" content="以番茄、蒜、罗勒和橄榄油完成的意大利国民经典，材料容易获得，关键在于酱汁收浓与面水乳化。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/family-spaghetti-pomodoro')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/family-spaghetti-pomodoro')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">经典番茄意面</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1125" height="750" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-family-spaghetti-pomodoro.webp'); ?>" alt="经典番茄意面"></figure><div class="lux-recipe-intro"><span>适合中国家庭的意大利菜</span><h1 id="lux-reader-title">经典番茄意面</h1><p>以番茄、蒜、罗勒和橄榄油完成的意大利国民经典，材料容易获得，关键在于酱汁收浓与面水乳化。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>35分钟</dd></div><div><dt>难度</dt><dd>简单</dd></div><div><dt>份量</dt><dd>4人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>干意大利细面 320克</li><li>番茄泥 500克</li><li>特级初榨橄榄油30克</li><li>蒜1瓣（约5克）</li><li>新鲜罗勒12克</li><li>细盐约7克（含煮面水）</li><li>保留煮面水约150毫升</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>宽锅中加入橄榄油和拍裂的蒜，以中低火加热至出香，不要上色过深。</li><li>加入番茄泥和少量盐，中小火煮约15–20分钟，期间偶尔搅拌。</li><li>加入一半罗勒，继续煮至酱汁浓稠而仍有流动性。</li><li>另锅烧足量水，加盐后放入意面。</li><li>意面煮至比包装标示的最佳嚼劲时间少约1分钟，保留约150毫升面水。</li><li>意面转入番茄酱锅，加入少量面水，中火翻拌约1分钟。</li><li>按需要继续少量补充面水，使酱汁均匀包裹面条。</li><li>关火，加入剩余罗勒并拌匀。</li><li>装盘后可淋少量橄榄油，立即上桌。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>约1530千焦 / 365千卡</dd></div><div><dt>脂肪</dt><dd>约9克</dd></div><div><dt>其中饱和脂肪</dt><dd>约1.5克</dd></div><div><dt>碳水化合物</dt><dd>约62克</dd></div><div><dt>其中糖</dt><dd>约7克</dd></div><div><dt>蛋白质</dt><dd>约12克</dd></div><div><dt>膳食纤维</dt><dd>约4克</dd></div><div><dt>钠</dt><dd>取决于煮面水盐度</dd></div></dl><p class="lux-recipe-nutrition-note"><strong>营养说明</strong>营养数据为每份估算值。</p></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>意大利国民经典</dd></div><div><dt>推荐用油</dt><dd>中等果香的特级初榨橄榄油。</dd></div><div><dt>专业提示</dt><dd>不要用糖修正番茄酱；应选择质量更好的番茄泥，或通过延长收汁获得自然甜度。</dd></div><div><dt>食品安全</dt><dd>开封番茄泥和煮熟意面应及时冷藏，不要在室温长时间放置。</dd></div><div><dt>过敏原提示</dt><dd>含麸质谷物；如使用含蛋意面则另含蛋。</dd></div><div><dt>可替换食材</dt><dd>可使用优质罐装番茄泥、全麦或无麸质意面；罗勒不建议用香菜替代。</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=olive-oil#product-catalogue')); ?>">LuxurEat（露意膳）特级初榨橄榄油与意面产品</a></dd></div></section></article></main>
<!-- lux:footer:start -->
