...
<!-- lux:seo:start -->
<title>经典玛格丽特披萨 | LuxurEat</title>
<meta name="description" content="以耐心发酵的面团、番茄、马苏里拉奶酪与罗勒，完成一张配料克制、饼边轻盈的经典披萨。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/pizza-margherita')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/pizza-margherita')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">经典玛格丽特披萨</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1800" height="1134" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-pizza-margherita.webp'); ?>" alt="经典玛格丽特披萨"></figure><div class="lux-recipe-intro"><span>披萨学院</span><h1 id="lux-reader-title">经典玛格丽特披萨</h1><p>以耐心发酵的面团、番茄、马苏里拉奶酪与罗勒，完成一张配料克制、饼边轻盈的经典披萨。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>准备30分钟＋发酵8—24小时</dd></div><div><dt>难度</dt><dd>中等</dd></div><div><dt>份量</dt><dd>2张小披萨</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>500克披萨面粉</li><li>325克水</li><li>10克盐</li><li>1克干酵母</li><li>250克番茄碎</li><li>200克马苏里拉奶酪</li><li>罗勒与特级初榨橄榄油</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>混合面粉、水和酵母，静置20分钟后加入盐，揉至面团光滑。</li><li>室温发酵后分割成两份，冷藏熟成8—24小时。</li><li>回温后轻柔展开面团，保留饼边气泡，铺上番茄与奶酪。</li><li>以烤箱可达到的最高温度烘烤至饼边膨起上色，出炉后加入罗勒与橄榄油。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>约2850千焦（约680千卡/张）</dd></div><div><dt>脂肪</dt><dd>约19克</dd></div><div><dt>碳水化合物</dt><dd>约98克</dd></div><div><dt>蛋白质</dt><dd>约28克</dd></div></dl></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>坎帕尼亚 / 那不勒斯</dd></div><div><dt>过敏原提示</dt><dd>含麸质与牛奶</dd></div><div><dt>可替换食材</dt><dd>可按面粉吸水率微调水量；新鲜马苏里拉可换低水分马苏里拉</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=pizza#product-catalogue')); ?>">披萨产品目录（以实际库存和标签为准）</a></dd></div></section></article></main>
<!-- lux:footer:start -->
