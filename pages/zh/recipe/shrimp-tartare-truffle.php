...
<!-- lux:seo:start -->
<title>脆爽蔬菜松露虾仁鞑靼 | LuxurEat</title>
<meta name="description" content="一道清新精致的菜肴，生虾的鲜甜与蔬菜的爽脆、松露的浓郁香气完美融合，兼具视觉美感和味觉享受。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/shrimp-tartare-truffle')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/shrimp-tartare-truffle')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">脆爽蔬菜松露虾仁鞑靼</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1000" height="667" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-shrimp-tartare-truffle.webp'); ?>" alt="脆爽蔬菜松露虾仁鞑靼"></figure><div class="lux-recipe-intro"><span>第二道主食</span><h1 id="lux-reader-title">脆爽蔬菜松露虾仁鞑靼</h1><p>一道清新精致的菜肴，生虾的鲜甜与蔬菜的爽脆、松露的浓郁香气完美融合，兼具视觉美感和味觉享受。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>20分钟</dd></div><div><dt>难度</dt><dd>简单</dd></div><div><dt>份量</dt><dd>2人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>200克新鲜红虾，去壳冷冻</li><li>4-5片新鲜黑松露</li><li>6个樱桃番茄</li><li>半根黄瓜</li><li>¼个黄甜椒</li><li>半个酸橙</li><li>1汤匙特级初榨橄榄油</li><li>盐和胡椒粉适量</li><li>几片沙拉叶和一些可食用花卉（用于装饰）</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>准备虾仁：用刀将虾仁切碎，直至达到细腻但不过于浓稠的状态。用橄榄油、青柠汁、盐和胡椒粉调味。</li><li>将黄瓜、小番茄和甜椒切成非常小的丁，拌成色彩鲜艳、口感爽脆的混合蔬菜。</li><li>用糕点切割器组装：底部放上蔬菜，然后将虾仁鞑靼放在上面。</li><li>用松露片、可食用花卉、少许油和几滴香醋浓缩汁或绿色乳液（可选）进行装饰。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>600千焦（约145千卡）</dd></div><div><dt>饱和脂肪</dt><dd>1克（5%）</dd></div><div><dt>碳水化合物（糖类）</dt><dd>2克</dd></div><div><dt>蛋白质</dt><dd>14克</dd></div></dl></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>参考：利古里亚海岸风味</dd></div><div><dt>推荐用油</dt><dd>清新果香型特级初榨橄榄油</dd></div><div><dt>过敏原提示</dt><dd>含甲壳类；可能含鱼类或芥末，按包装确认</dd></div><div><dt>可替换食材</dt><dd>生虾可改用彻底加热的虾；青柠可用柠檬替代</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=truffle#product-catalogue')); ?>">松露产品目录（以实际库存和标签为准）</a></dd></div></section></article></main>
<!-- lux:footer:start -->
