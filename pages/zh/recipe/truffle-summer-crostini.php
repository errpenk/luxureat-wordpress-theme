...
<!-- lux:seo:start -->
<title>翁布里亚夏季黑松露烤面包 | LuxurEat</title>
<meta name="description" content="翁布里亚风格烤面包以蒜香橄榄油承接夏季松露，低温处理并在最后刨片，保留易挥发香气。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/truffle-summer-crostini')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/truffle-summer-crostini')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">翁布里亚夏季黑松露烤面包</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1200" height="800" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-truffle-summer-crostini.webp'); ?>" alt="翁布里亚夏季黑松露烤面包"></figure><div class="lux-recipe-intro"><span>松露食谱</span><h1 id="lux-reader-title">翁布里亚夏季黑松露烤面包</h1><p>翁布里亚风格烤面包以蒜香橄榄油承接夏季松露，低温处理并在最后刨片，保留易挥发香气。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>20分钟</dd></div><div><dt>难度</dt><dd>简单</dd></div><div><dt>份量</dt><dd>4人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>乡村面包200克，切8片</li><li>夏季松露 夏季黑松露 30克</li><li>特级初榨橄榄油50克</li><li>蒜1瓣（约5克）</li><li>细盐1.5克</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>松露以软刷彻底刷去泥土，快速冲洗后立即擦干。</li><li>将20克松露细磨，剩余10克留作刨片。</li><li>橄榄油与拍裂的蒜以极低火温热，不要让蒜上色。</li><li>移除蒜并让油稍微降温，再拌入磨碎松露和盐。</li><li>面包烤至两面金黄酥脆。</li><li>趁热将松露油酱均匀涂在烤面包上。</li><li>刨上剩余松露，立即上桌。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>约1090千焦 / 260千卡</dd></div><div><dt>脂肪</dt><dd>约13克</dd></div><div><dt>其中饱和脂肪</dt><dd>约2克</dd></div><div><dt>碳水化合物</dt><dd>约26克</dd></div><div><dt>其中糖</dt><dd>约3克</dd></div><div><dt>蛋白质</dt><dd>约6克</dd></div><div><dt>膳食纤维</dt><dd>约2.5克</dd></div><div><dt>钠</dt><dd>约400毫克</dd></div></dl><p class="lux-recipe-nutrition-note"><strong>营养说明</strong>营养数据为每份估算值。</p></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>翁布里亚</dd></div><div><dt>推荐用油</dt><dd>风味温和、不压过松露的特级初榨橄榄油。</dd></div><div><dt>专业提示</dt><dd>松露香气具有挥发性，不应长时间高温加热；磨碎部分只在油稍降温后加入。</dd></div><div><dt>食品安全</dt><dd>松露属于带土食材，必须刷洗干净、擦干并冷藏保存。</dd></div><div><dt>过敏原提示</dt><dd>含麸质谷物（面包）。</dd></div><div><dt>可替换食材</dt><dd>可用其他黑松露替代，但应按香气强度调整用量。</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=truffle#product-catalogue')); ?>">LuxurEat（露意膳）松露与特级初榨橄榄油产品</a></dd></div></section></article></main>
<!-- lux:footer:start -->
