...
<!-- lux:seo:start -->
<title>蒜香辣椒橄榄油意面 | LuxurEat</title>
<meta name="description" content="经典的 蒜香辣椒橄榄油意面 依靠蒜、辣椒、特级初榨橄榄油和富含淀粉的面水形成轻薄乳化，而不是用大量油把意面浸湿。">
<!-- lux:seo:end -->
<!-- Fonts -->

<!-- lux:fonts:start -->
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-rituals-critical.woff2?v=20260906-mobile-service-fixes-52'); ?>" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-rituals-critical.woff2?v=20260906-mobile-service-fixes-52'); ?>" as="font" type="font/woff2" crossorigin>
...
<style data-lux-critical-fonts>@font-face{font-family:"KingHwa Page Critical";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-rituals-critical.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:block}@font-face{font-family:"KingHwa Old Song Site";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/KingHwaOldSong-site.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:700;font-style:normal;font-display:block}@font-face{font-family:"ZhiSong Page Critical";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-rituals-critical.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:swap}@font-face{font-family:"LuxurEat ZhiSong Site";src:url("<?php echo esc_url(get_template_directory_uri() . '/assets/fonts/LuxurEatZhiSong-site.woff2?v=20260906-mobile-service-fixes-52'); ?>") format("woff2");font-weight:400;font-style:normal;font-display:swap}html[lang^="zh"]{--lux-page-heading:"KingHwa Page Critical","KingHwa Old Song Site"!important;--lux-zh-headline:"KingHwa Page Critical","KingHwa Old Song Site"!important;--lux-zh-body:"ZhiSong Page Critical","LuxurEat ZhiSong Site"!important}</style>
<!-- lux:fonts:end -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/olive-pasta')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/olive-pasta')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">蒜香辣椒橄榄油意面</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="500" height="334" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-olive-aglio-olio.webp'); ?>" alt="蒜香辣椒橄榄油意面"></figure><div class="lux-recipe-intro"><span>橄榄油食谱</span><h1 id="lux-reader-title">蒜香辣椒橄榄油意面</h1><p>经典的 蒜香辣椒橄榄油意面 依靠蒜、辣椒、特级初榨橄榄油和富含淀粉的面水形成轻薄乳化，而不是用大量油把意面浸湿。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>20分钟</dd></div><div><dt>难度</dt><dd>简单</dd></div><div><dt>份量</dt><dd>4人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>干意大利细面 320克</li><li>特级初榨橄榄油60克（约66毫升）</li><li>蒜4瓣（约20克），切薄片</li><li>干辣椒1–2个，或辣椒碎1–2克</li><li>新鲜欧芹12克，切碎，可选但推荐</li><li>细盐约6克，用于煮面水</li><li>保留煮面水约150毫升</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>在充足沸水中加盐，放入意面，煮至比包装标示的最佳嚼劲时间少约1分钟，舀出约150毫升面水备用。</li><li>冷锅加入橄榄油和蒜片，以中低火缓慢加热。蒜应逐渐释放香气并变成浅金色，不要炸至深褐。</li><li>加入辣椒，继续低火加热数十秒。</li><li>将意面直接转入锅中，加入约80毫升面水，以中火快速翻拌。</li><li>根据需要少量补充面水，使橄榄油和淀粉水形成乳化，并均匀附着在面条表面。</li><li>当意面达到理想嚼劲、锅底几乎没有游离水分时关火，加入欧芹，翻拌后立即装盘。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>约1810千焦 / 435千卡</dd></div><div><dt>脂肪</dt><dd>约16克</dd></div><div><dt>其中饱和脂肪</dt><dd>约2.5克</dd></div><div><dt>碳水化合物</dt><dd>约59克</dd></div><div><dt>其中糖</dt><dd>约3克</dd></div><div><dt>蛋白质</dt><dd>约11克</dd></div><div><dt>膳食纤维</dt><dd>约3克</dd></div><div><dt>钠</dt><dd>取决于煮面水盐度和沥水程度</dd></div></dl><p class="lux-recipe-nutrition-note"><strong>营养说明</strong>营养数据为每份估算值。煮面水中的盐不会全部进入最终成品。</p></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>坎帕尼亚及意大利南部传统</dd></div><div><dt>推荐用油</dt><dd>中等果香、带适度辛香感的特级初榨橄榄油。</dd></div><div><dt>专业提示</dt><dd>重点不是油越多越好，而是通过面水中的淀粉完成乳化。蒜如果炸焦，会产生明显苦味。</dd></div><div><dt>食品安全</dt><dd>煮熟意面不宜在室温下长时间放置。如非立即食用，应尽快冷却并冷藏。</dd></div><div><dt>过敏原提示</dt><dd>含麸质谷物（意面）；如使用含蛋意面，则另含蛋。</dd></div><div><dt>可替换食材</dt><dd>可使用全麦意面或经认证的无麸质意面。辣椒可按口味减少，但标准版本不建议用香菜替代欧芹。</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=olive-oil#product-catalogue')); ?>">LuxurEat（露意膳）特级初榨橄榄油与意大利面产品</a></dd></div></section></article></main>
<!-- lux:footer:start -->
