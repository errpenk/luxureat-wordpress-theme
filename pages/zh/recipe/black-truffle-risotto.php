...
<!-- lux:seo:start -->
<title>黑松露烩饭 | LuxurEat</title>
<meta name="description" content="黑松露烩饭将奶油米饭的香滑口感与松露的浓郁风味完美结合，成就了一道制作简单却又精致美味的佳肴。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/black-truffle-risotto')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/black-truffle-risotto')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">黑松露烩饭</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="1000" height="667" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-black-truffle-risotto.webp'); ?>" alt="黑松露烩饭"></figure><div class="lux-recipe-intro"><span>第一道主食</span><h1 id="lux-reader-title">黑松露烩饭</h1><p>黑松露烩饭将奶油米饭的香滑口感与松露的浓郁风味完美结合，成就了一道制作简单却又精致美味的佳肴。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>30分钟</dd></div><div><dt>难度</dt><dd>中等</dd></div><div><dt>份量</dt><dd>2人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>160克卡纳罗利米</li><li>20克黄油</li><li>1汤匙特级初榨橄榄油</li><li>30克磨碎的帕玛森干酪</li><li>半个小洋葱（或青葱）</li><li>50毫升干白葡萄酒</li><li>4-5片新鲜黑松露薄片</li><li>盐和胡椒粉适量</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>将洋葱切碎，放入平底锅中，加入黄油和少许油，用小火炒至变色。</li><li>烘烤：加入卡纳罗利米，翻炒2-3分钟，直至米粒变得透明。</li><li>脱釉：倒入白葡萄酒，让其完全蒸发。</li><li>烹煮时，逐渐加入热肉汤，一次一勺，并不断搅拌。继续烹煮约15-18分钟。</li><li>关火后，加入磨碎的帕玛森奶酪和一小块黄油，搅拌至顺滑浓稠。</li><li>装饰盘子，最后撒上新鲜黑松露碎屑和少许胡椒粉。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>1800千焦（约430千卡）</dd></div><div><dt>饱和脂肪</dt><dd>8克（40%）</dd></div><div><dt>碳水化合物（糖类）</dt><dd>2克</dd></div><div><dt>蛋白质</dt><dd>10克</dd></div></dl></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>参考：皮埃蒙特 / 伦巴第风味</dd></div><div><dt>推荐用油</dt><dd>结构感中等的特级初榨橄榄油</dd></div><div><dt>过敏原提示</dt><dd>含奶；高汤与奶酪需按包装确认麸质和其他过敏原</dd></div><div><dt>可替换食材</dt><dd>卡纳罗利米可替换为其他圆粒米；白葡萄酒可用无酒精高汤替代</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=truffle#product-catalogue')); ?>">松露产品目录（以实际库存和标签为准）</a></dd></div></section></article></main>
<!-- lux:footer:start -->
