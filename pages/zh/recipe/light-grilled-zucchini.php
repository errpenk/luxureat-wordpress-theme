...
<!-- lux:seo:start -->
<title>香草柠檬腌烤西葫芦 | LuxurEat</title>
<meta name="description" content="薄切西葫芦经高温快速烤制，再以柠檬、薄荷、蒜与橄榄油短暂腌渍，保留清脆质地。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/light-grilled-zucchini')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/light-grilled-zucchini')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">香草柠檬腌烤西葫芦</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="500" height="333" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-light-grilled-zucchini.webp'); ?>" alt="香草柠檬腌烤西葫芦"></figure><div class="lux-recipe-intro"><span>健康轻食</span><h1 id="lux-reader-title">香草柠檬腌烤西葫芦</h1><p>薄切西葫芦经高温快速烤制，再以柠檬、薄荷、蒜与橄榄油短暂腌渍，保留清脆质地。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>35分钟（含短暂腌渍）</dd></div><div><dt>难度</dt><dd>简单</dd></div><div><dt>份量</dt><dd>4人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>西葫芦700克</li><li>特级初榨橄榄油30克（约33毫升）</li><li>新鲜柠檬汁25克</li><li>蒜1瓣（约5克），切末</li><li>新鲜薄荷8克，或欧芹10克</li><li>细盐2.5克</li><li>现磨黑胡椒适量</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>西葫芦洗净擦干，纵向切成4–5毫米厚片。</li><li>烤盘或烤架充分预热。</li><li>西葫芦分批铺开，每面烤约1–2分钟至出现烤痕且刚刚变软，不要堆叠。</li><li>橄榄油、柠檬汁、蒜、盐和黑胡椒混合，加入切碎薄荷。</li><li>将温热西葫芦分层摆放，每层刷少量调味汁。</li><li>静置约15分钟入味；若不立即食用，应冷藏保存。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>约485千焦 / 115千卡</dd></div><div><dt>脂肪</dt><dd>约8克</dd></div><div><dt>其中饱和脂肪</dt><dd>约1克</dd></div><div><dt>碳水化合物</dt><dd>约7克</dd></div><div><dt>其中糖</dt><dd>约5克</dd></div><div><dt>蛋白质</dt><dd>约3克</dd></div><div><dt>膳食纤维</dt><dd>约2克</dd></div><div><dt>钠</dt><dd>约260毫克</dd></div></dl><p class="lux-recipe-nutrition-note"><strong>营养说明</strong>营养数据为每份估算值。</p></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>意大利家庭料理</dd></div><div><dt>推荐用油</dt><dd>清新、果香温和的特级初榨橄榄油。</dd></div><div><dt>专业提示</dt><dd>不要把西葫芦烤得过软；高温短时加热才能保留结构和清新感。</dd></div><div><dt>食品安全</dt><dd>烤后尽快冷却或及时食用。含新鲜蒜的油汁不可在室温长期存放。</dd></div><div><dt>过敏原提示</dt><dd>标准配方不含欧盟14大主要过敏原。</dd></div><div><dt>可替换食材</dt><dd>薄荷可换为欧芹；部分柠檬汁可换为白酒醋。</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=olive-oil#product-catalogue')); ?>">LuxurEat（露意膳）特级初榨橄榄油产品</a></dd></div></section></article></main>
<!-- lux:footer:start -->
