...
<!-- lux:seo:start -->
<title>翁布里亚黑松露鳟鱼 | LuxurEat</title>
<meta name="description" content="来自翁布里亚 瓦尔内里纳 的传统搭配，以温和烹调的鳟鱼承接黑松露和蒜香橄榄油。">
<!-- lux:seo:end -->
<!-- Fonts -->
...
<header class="lux-header">
  ...
  <div class="lux-actions">
    ...
    <span class="lux-lang"><a class="active" href="<?php echo esc_url(luxureat_static_url('recipe/truffle-trout')); ?>">ZH</a><span>/</span><a href="<?php echo esc_url(luxureat_static_url('en/recipe/truffle-trout')); ?>">EN</a></span>
    <button class="lux-menu" type="button" data-open="关闭" data-closed="菜单" aria-expanded="false">菜单</button>
  </div>
</header>
<!-- lux:header:end -->
<main class="lux-article-page"><nav class="lux-breadcrumb" aria-label="面包屑导航"><a href="<?php echo esc_url(luxureat_static_url('zh', '')); ?>">首页</a><span aria-hidden="true">/</span><a href="<?php echo esc_url(luxureat_static_url('zh/recipe', '')); ?>">食谱艺术</a><span aria-hidden="true">/</span><span aria-current="page">翁布里亚黑松露鳟鱼</span></nav><article class="lux-recipe-reader lux-recipe-seo-page"><section class="lux-recipe-hero"><figure><img width="612" height="406" loading="eager" fetchpriority="high" decoding="async" src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/journal/recipe-truffle-trout.webp'); ?>" alt="翁布里亚黑松露鳟鱼"></figure><div class="lux-recipe-intro"><span>松露食谱</span><h1 id="lux-reader-title">翁布里亚黑松露鳟鱼</h1><p>来自翁布里亚 瓦尔内里纳 的传统搭配，以温和烹调的鳟鱼承接黑松露和蒜香橄榄油。</p><dl class="lux-recipe-facts"><div><dt>时间</dt><dd>35分钟</dd></div><div><dt>难度</dt><dd>中等</dd></div><div><dt>份量</dt><dd>2人份</dd></div></dl></div></section><section class="lux-recipe-body"><aside class="lux-recipe-ingredients"><h2>食材</h2><ul><li>整条去内脏鳟鱼2条，每条约300克</li><li>黑松露30克</li><li>特级初榨橄榄油30克</li><li>蒜1瓣（约5克）</li><li>细盐3克</li><li>新鲜欧芹5克，可选</li></ul></aside><div class="lux-recipe-method"><h2>准备</h2><ol><li>鳟鱼清理干净，冲洗后彻底擦干。</li><li>鱼腹和表面轻撒盐。</li><li>烤箱预热至190°C，鳟鱼放入烤盘并淋少量橄榄油。</li><li>烤约15–18分钟，至鱼肉刚熟、中心温度达到63°C。</li><li>其余橄榄油与拍裂的蒜以低火温热，不要上色。</li><li>移除蒜，加入20克细磨黑松露。</li><li>鳟鱼去头、去骨并保持鱼肉完整。</li><li>将松露油汁淋在鱼肉上。</li><li>刨上剩余10克松露，可用欧芹点缀后立即上桌。</li></ol></div></section><section class="lux-recipe-nutrition"><header><h2>每份的估计营养成分</h2></header><dl><div><dt>能量</dt><dd>约2280千焦 / 545千卡</dd></div><div><dt>脂肪</dt><dd>约35克</dd></div><div><dt>其中饱和脂肪</dt><dd>约6克</dd></div><div><dt>碳水化合物</dt><dd>约1克</dd></div><div><dt>其中糖</dt><dd>少于1克</dd></div><div><dt>蛋白质</dt><dd>约63克</dd></div><div><dt>膳食纤维</dt><dd>约0.5克</dd></div><div><dt>钠</dt><dd>约730毫克</dd></div></dl><p class="lux-recipe-nutrition-note"><strong>营养说明</strong>营养数据为每份估算值。</p></section><section class="lux-recipe-details"><div><dt>参考产区</dt><dd>翁布里亚 瓦尔内里纳</dd></div><div><dt>推荐用油</dt><dd>温和果香的特级初榨橄榄油。</dd></div><div><dt>专业提示</dt><dd>酱汁应保持简单，鱼肉也不要过熟；温润鱼肉能承接松露，而不会被强烈调味覆盖。</dd></div><div><dt>食品安全</dt><dd>生鱼应冷藏并与即食食材分开处理；中心温度达到63°C。剩余成品及时冷藏。</dd></div><div><dt>过敏原提示</dt><dd>含鱼类。</dd></div><div><dt>可替换食材</dt><dd>可用肉质细嫩的淡水鱼替代，但不应称为传统 瓦尔内里纳 版本。</dd></div><div><dt>相关产品</dt><dd><a class="lux-recipe-product-link" href="<?php echo esc_url(luxureat_static_url('zh/product', '?category=truffle#product-catalogue')); ?>">LuxurEat（露意膳）黑松露与特级初榨橄榄油产品</a></dd></div></section></article></main>
<!-- lux:footer:start -->
